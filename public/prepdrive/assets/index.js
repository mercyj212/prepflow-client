...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Cs(e,t,n){let r=new Float32Array(ls),i=new V(0,1,0);return new xa({name:`SphericalGaussianBlur`,defines:{n:ls,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Es(),fragmentShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Wc(i,i.VERTEX_SHADER,y),S=Wc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Xc(i,x,`vertex`),n=Xc(i,S,`fragment`);L(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){let e=new Worker(this.workerSourceURL);e._callbacks={},e._taskCosts={},e._taskLoad=0,e.postMessage({type:`init`,decoderConfig:this.decoderConfig}),e.onmessage=function(t){let n=t.data;switch(n.type){case`decode`:e._callbacks[n.id].resolve(n);break;case`error`:e._callbacks[n.id].reject(n);break;default:console.error(`THREE.DRACOLoader: Unexpected message, "`+n.type+`"`)}},this.workerPool.push(e)}else this.workerPool.sort(function(e,t){return e._taskLoad>t._taskLoad?-1:1});let n=this.workerPool[this.workerPool.length-1];return n._taskCosts[e]=t,n._taskLoad+=t,n})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log(`Task load: `,this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==``&&URL.revokeObjectURL(this.workerSourceURL),this}};function gd(){let e,t;onmessage=function(r){let i=r.data;switch(i.type){case`init`:e=i.decoderConfig,t=new Promise(function(t){e.onModuleLoaded=function(e){t({draco:e})},DracoDecoderModule(e)});break;case`decode`:let r=i.buffer,a=i.taskConfig;t.then(e=>{let t=e.draco,o=new t.Decoder;try{let e=n(t,o,new Int8Array(r),a),s=e.attributes.map(e=>e.array.buffer);e.index&&s.push(e.index.array.buffer),self.postMessage({type:`decode`,id:i.id,geometry:e},s)}catch(e){console.error(e),self.postMessage({type:`error`,id:i.id,error:e.message})}finally{t.destroy(o)}});break}};function n(e,t,n,a){let o=a.attributeIDs,s=a.attributeTypes,c,l,u=t.GetEncodedGeometryType(n);if(u===e.TRIANGULAR_MESH)c=new e.Mesh,l=t.DecodeArrayToMesh(n,n.byteLength,c);else if(u===e.POINT_CLOUD)c=new e.PointCloud,l=t.DecodeArrayToPointCloud(n,n.byteLength,c);else throw Error(`THREE.DRACOLoader: Unexpected geometry type.`);if(!l.ok()||c.ptr===0)throw Error(`THREE.DRACOLoader: Decoding failed: `+l.error_msg());let d={index:null,attributes:[]};for(let n in o){let r=self[s[n]],l,u;if(a.useUniqueIDs)u=o[n],l=t.GetAttributeByUniqueId(c,u);else{if(u=t.GetAttributeId(c,e[o[n]]),u===-1)continue;l=t.GetAttribute(c,u)}let f=i(e,t,c,n,r,l);n===`color`&&(f.vertexColorSpace=a.vertexColorSpace),d.attributes.push(f)}return u===e.TRIANGULAR_MESH&&(d.index=r(e,t,c)),e.destroy(c),d}function r(e,t,n){let r=n.num_faces()*3,i=r*4,a=e._malloc(i);t.GetTrianglesUInt32Array(n,i,a);let o=new Uint32Array(e.HEAPF32.buffer,a,r).slice();return e._free(a),{array:o,itemSize:1}}function i(e,t,n,r,i,o){let s=n.num_points(),c=o.num_components(),l=a(e,i),u=c*i.BYTES_PER_ELEMENT,d=Math.ceil(u/4)*4,f=d/i.BYTES_PER_ELEMENT,p=s*u,m=s*d,h=e._malloc(p);t.GetAttributeDataArrayForAllPoints(n,o,l,p,h);let g=new i(e.HEAPF32.buffer,h,p/i.BYTES_PER_ELEMENT),_;if(u===d)_=g.slice();else{_=new i(m/i.BYTES_PER_ELEMENT);let e=0;for(let t=0,n=g.length;t<n;t++){for(let n=0;n<c;n++)_[e+n]=g[t*c+n];e+=f}}return e._free(h),{name:r,count:s,itemSize:c,array:_,stride:f}}function a(e,t){switch(t){case Float32Array:return e.DT_FLOAT32;case Int8Array:return e.DT_INT8;case Int16Array:return e.DT_INT16;case Int32Array:return e.DT_INT32;case Uint8Array:return e.DT_UINT8;case Uint16Array:return e.DT_UINT16;case Uint32Array:return e.DT_UINT32}}}var _d={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Od.BlurDirectionX=new B(1,0),Od.BlurDirectionY=new B(0,1);var Z=new Ln;Z.background=new G(8894680),Z.fog=new In(13164008,80,280);var kd=new vo(60,window.innerWidth/window.innerHeight,.1,300),Ad=new du({antialias:!0,powerPreference:`high-performance`,failIfMajorPerformanceCaveat:!1});Ad.setSize(window.innerWidth,window.innerHeight),Ad.setPixelRatio(window.devicePixelRatio),Ad.shadowMap.enabled=!0,Ad.shadowMap.type=1,Ad.toneMapping=4,Ad.toneMappingExposure=1.1,(document.getElementById(`root`)??document.body).appendChild(Ad.domElement);var jd=new(window.AudioContext||window.webkitAudioContext),Md,Nd,Pd;function Fd(){if(Pd)return;Pd=jd.createGain(),Pd.connect(jd.destination),Pd.gain.value=.3,Md=jd.createOscillator(),Md.type=`sawtooth`;let e=jd.createGain(),t=jd.createBiquadFilter();t.type=`lowpass`,t.frequency.value=400,Md.connect(t),t.connect(e),e.connect(Pd),e.gain.value=.1,Md.start();let n=2*jd.sampleRate,r=jd.createBuffer(1,n,jd.sampleRate),i=r.getChannelData(0);for(let e=0;e<n;e++)i[e]=Math.random()*2-1;Nd=jd.createBufferSource(),Nd.buffer=r,Nd.loop=!0;let a=jd.createBiquadFilter();a.type=`lowpass`,a.frequency.value=500;let o=jd.createGain();Nd.connect(a),a.connect(o),o.connect(Pd),o.gain.value=.05,Nd.start(),window.audioData={engineFilter:t,engineGain:e,engineOsc:Md,windFilter:a,windGain:o}}function Id(e,t,n){if(!Pd)return;let r=jd.createOscillator(),i=jd.createGain();r.type=t,r.frequency.setValueAtTime(e,jd.currentTime),r.frequency.exponentialRampToValueAtTime(10,jd.currentTime+n),i.gain.setValueAtTime(.2,jd.currentTime),i.gain.exponentialRampToValueAtTime(.01,jd.currentTime+n),r.connect(i),i.connect(Pd),r.start(),r.stop(jd.currentTime+n)}Ad.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),console.warn(`WebGL context lost — close other WebGL tabs and refresh.`);let t=document.createElement(`div`);t.style.cssText=`position:fixed;inset:0;background:#000;color:#fff;display:flex;align-items:center;justify-content:center;z-index:9999;font-family:monospace;font-size:1.2rem;text-align:center;padding:2rem;`,t.innerHTML=`<div><b style="color:#ff4444">WEBGL CONTEXT LOST</b><br><br>Close other browser tabs then<br><br><button onclick="location.reload()" style="padding:1rem 2rem;background:#fff;color:#000;border:none;cursor:pointer;font-weight:900;font-size:1rem;">RELOAD GAME</button></div>`,document.body.appendChild(t)},!1),Ad.domElement.addEventListener(`webglcontextrestored`,()=>{console.log(`WebGL context restored.`),Ad.setAnimationLoop(_m)},!1);var Ld=new Ed(Z,kd),Rd=new Od(new B(window.innerWidth,window.innerHeight),.15,.05,.92),zd=new Td(Ad);zd.addPass(Ld),zd.addPass(Rd);function Bd(){let e=document.createElement(`canvas`);e.width=512,e.height=512;let n=e.getContext(`2d`);n.fillStyle=`#2a2a2d`,n.fillRect(0,0,512,512);for(let e=0;e<4e4;e++){let e=Math.random()*512,t=Math.random()*512,r=Math.random()*15;n.fillStyle=`rgb(${35+r},${35+r},${38+r})`,n.fillRect(e,t,1,1)}n.fillStyle=`rgba(0,0,0,0.15)`,n.fillRect(512*.1,0,512*.25,512),n.fillRect(512*.65,0,512*.25,512);let r=new aa(e);return r.wrapS=r.wrapT=t,r.repeat.set(4,1e3),r}var Vd=new q({map:Bd(),color:16777215,roughness:.9,metalness:.05}),Hd=new q({color:7043674,roughness:1});function Ud(){let e=new la(1,1,1);[new q({color:13157564,roughness:.8}),new q({color:10137796,roughness:.2,metalness:.5}),new q({color:14538960,roughness:.9})].forEach((t,n)=>{let r=new Oi(e,t,17);r.frustumCulled=!0;let i=new Dn;for(let e=0;e<17;e++){let t=12+Math.random()*22,a=20+Math.random()*60,o=12+Math.random()*22,s=(e+n)%2==0?1:-1;i.position.set(s*(55+Math.random()*80),a/2,-100-n*60-e*35),i.scale.set(t,a,o),i.updateMatrix(),r.setMatrixAt(e,i.matrix)}r.instanceMatrix.needsUpdate=!0,Z.add(r)})}Ud();var Wd=new Eo(15266040,.8);Z.add(Wd);var Gd=new ao(14215416,4013357,.6);Z.add(Gd);var Kd=new To(16774630,1.8);Kd.position.set(100,150,80),Kd.castShadow=!0,Kd.shadow.mapSize.width=1024,Kd.shadow.mapSize.height=1024,Kd.shadow.camera.left=-50,Kd.shadow.camera.right=50,Kd.shadow.camera.top=50,Kd.shadow.camera.bottom=-50,Z.add(Kd);var qd=new To(11192552,.4);qd.position.set(-40,20,-30),Z.add(qd);var Jd=new K(new da(400,1200),Hd);Jd.name=`ground`,Jd.rotation.x=-Math.PI/2,Jd.position.set(0,-.05,-100),Z.add(Jd);var Yd=1e4,Xd=16,Zd=new K(new da(Xd,Yd),Vd);Zd.name=`road`,Zd.rotation.x=-Math.PI/2,Zd.position.set(0,.01,-Yd/2+50),Zd.receiveShadow=!0,Z.add(Zd);var Qd=new q({color:1710620,roughness:1}),$d=new da(1.5,Yd);[-1,1].forEach(e=>{let t=new K($d,Qd);t.rotation.x=-Math.PI/2,t.position.set(e*(Xd/2+.75),.005,-Yd/2+50),Z.add(t)});var ef=new q({color:10262672,roughness:.85}),tf=new la(.5,1.1,4),nf=750,rf=new Oi(tf,ef,nf*2),af=new Dn;for(let e=0;e<nf;e++)for(let t=-1;t<=1;t+=2)af.position.set(t*(Xd/2+.3),.55,-e*4),af.updateMatrix(),rf.setMatrixAt(e*2+ +(t===1),af.matrix);rf.instanceMatrix.needsUpdate=!0,Z.add(rf);var of=new On;Z.add(of);var sf=new Gr({color:16777215}),cf=new Gr({color:16766720}),lf=new K(new da(.2,Yd),cf);lf.rotation.x=-Math.PI/2,lf.position.set(-Xd/2+.4,.06,-Yd/2+50),of.add(lf);var uf=new K(new da(.2,Yd),sf);uf.rotation.x=-Math.PI/2,uf.position.set(Xd/2-.4,.06,-Yd/2+50),of.add(uf),[-4,0,4].forEach((e,t)=>{for(let n=0;n<150;n++){let r=new K(new da(.15,6),sf);if(r.rotation.x=-Math.PI/2,r.position.set(e,.05,50-n*20),of.add(r),n%2==0){let r=new K(new la(.12,.08,.12),new Gr({color:t===0?16766720:16777215}));r.position.set(e,.08,50-n*20+3.5),of.add(r)}}});var df=new ua(.1,.15,8,8),ff=new q({color:4473924,metalness:.8,roughness:.2}),pf=new la(2,.1,.1),mf=new la(.6,.2,.4),hf=new q({color:2236962}),gf=new Gr({color:16777198}),_f=new da(.5,.3),vf=new Oi(df,ff,150),yf=new Oi(pf,ff,150),bf=new Oi(mf,hf,150),xf=new Dn;for(let e=0;e<75;e++){let t=e%2==0?-1:1,n=-e*40;xf.position.set(t*(Xd/2+2.5),4,n),xf.updateMatrix(),vf.setMatrixAt(e,xf.matrix),xf.position.set(t*(Xd/2+1.6),8,n),xf.rotation.z=0,xf.updateMatrix(),yf.setMatrixAt(e,xf.matrix),xf.position.set(t*(Xd/2+.7),7.9,n),xf.updateMatrix(),bf.setMatrixAt(e,xf.matrix);let r=new K(_f,gf);r.rotation.x=Math.PI/2,r.position.set(t*(Xd/2+.7),7.75,n),Z.add(r)}vf.instanceMatrix.needsUpdate=!0,yf.instanceMatrix.needsUpdate=!0,bf.instanceMatrix.needsUpdate=!0,Z.add(vf,yf,bf);var Sf=new la(.4,12,.4),Cf=new da(8,3),wf=new q({color:19750,roughness:.5});for(let e=0;e<10;e++){let t=-450-e*600,n=new K(Sf,ff);n.position.set(-Xd/2-2,6,t),Z.add(n);let r=n.clone();r.position.x=Xd/2+2,Z.add(r);let i=new K(new la(Xd+4,.3,.3),ff);i.position.set(0,11,t),Z.add(i);let a=new K(Cf,wf);a.position.set(0,9,t+.2),Z.add(a)}var Tf={basic:[{q:`Solve: 15 + 27`,a:[`32`,`42`,`45`,`52`],c:1},{q:`Which word is a synonym for 'Happy'?`,a:[`Gloomy`,`Cheerful`,`Bored`,`Angry`],c:1},{q:`What is 10% of 500?`,a:[`5`,`50`,`100`,`500`],c:1},{q:`Identify the noun: 'The blue car drove fast.'`,a:[`Blue`,`Fast`,`Car`,`Drove`],c:2},{q:`Complete: 2, 4, 8, 16, ...`,a:[`24`,`32`,`20`,`64`],c:1},{q:`What is 3 squared plus 4 squared?`,a:[`7`,`12`,`25`,`49`],c:2},{q:`Which of these is an even number?`,a:[`13`,`27`,`42`,`55`],c:2},{q:`Antonym of 'Hot'?`,a:[`Warm`,`Cold`,`Burning`,`Spicy`],c:1},{q:`How many sides does a hexagon have?`,a:[`5`,`6`,`7`,`8`],c:1},{q:`Identify the verb: 'She jumped over the fence.'`,a:[`Fence`,`Jumped`,`Over`,`She`],c:1},{q:`Simplify: 40 / 5 + 2`,a:[`8`,`10`,`6`,`12`],c:1}],advanced:[{q:`If x + 7 = 15, what is the value of x^2?`,a:[`64`,`49`,`81`,`121`],c:0},{q:`Which word is a synonym for 'Abundant'?`,a:[`Scarce`,`Plentiful`,`Sparse`,`Rare`],c:1},{q:`What is the area of a circle with radius 3? (Approx)`,a:[`18.8`,`28.3`,`9.4`,`12.6`],c:1},{q:`Complete the analogy: Book is to Read as Fork is to...`,a:[`Drink`,`Cut`,`Eat`,`Wash`],c:2},{q:`Which of these is a prime number?`,a:[`15`,`21`,`29`,`33`],c:2},{q:`What is the square root of 225?`,a:[`13`,`14`,`15`,`16`],c:2},{q:`Solve for y: 3y - 9 = 21`,a:[`8`,`10`,`12`,`6`],c:1},{q:`Who wrote 'Hamlet'?`,a:[`Dickens`,`Twain`,`Shakespeare`,`Homer`],c:2},{q:`What is the chemical symbol for Gold?`,a:[`Ag`,`Fe`,`Au`,`Pb`],c:2},{q:`Convert 2/5 to a percentage.`,a:[`20%`,`40%`,`50%`,`25%`],c:1},{q:`What is the slope of the line y = 3x - 5?`,a:[`-5`,`3`,`-3`,`5`],c:1},{q:`Which word means 'to move away from'?`,a:[`Accede`,`Recede`,`Proceed`,`Concede`],c:1},{q:`If a triangle has angles 40 and 60, what is the third angle?`,a:[`80`,`90`,`100`,`70`],c:0},{q:`What is the main gas in Earth's atmosphere?`,a:[`Oxygen`,`Nitrogen`,`Carbon`,`Argon`],c:1},{q:`Solve: 2^4 - 2^3`,a:[`8`,`16`,`4`,`12`],c:0},{q:`Identify the figure of speech: 'The wind whispered.'`,a:[`Simile`,`Metaphor`,`Personification`,`Hyperbole`],c:2}]},Ef=[7103487,16737668,4450481,16760331,3835647,54527,16711765,7103487,16760331,4450481],Df=[];for(let e=1;e<=20;e++)Df.push(-e*280);var Of=[];Df.forEach((e,t)=>{let n=new K(new la(.8,4.5,.8),new q({color:1118481,metalness:.9,roughness:.1}));n.name=`checkpointPillarLeft_${t}`,n.position.set(-Xd/2-1.2,2.25,e),Z.add(n);let r=n.clone();r.name=`checkpointPillarRight_${t}`,r.position.set(Xd/2+1.2,2.25,e),Z.add(r);let i=new K(new la(Xd+3.5,.6,1.2),new q({color:1118481,metalness:1,roughness:.05}));i.name=`checkpointArch_${t}`,i.position.set(0,4.5,e),Z.add(i);let a=new K(new da(Xd-.8,4.5),new Gr({color:Ef[t%Ef.length],transparent:!0,opacity:.15,side:2}));a.position.set(0,2.25,e),Z.add(a),Of.push({arch:i,z:e,color:Ef[t%Ef.length],curtain:a})});var kf=document.getElementById(`loading-status`),Af=document.getElementById(`start-btn`),jf=document.getElementById(`start-overlay`),Mf=document.getElementById(`crash-overlay`),Nf=new Ja,Pf=!1;Nf.onProgress=(e,t,n)=>{let r=Math.round(t/n*100);kf&&(kf.textContent=`LOADING ASSETS: ${r}%`)},Nf.onLoad=()=>{Pf||(Pf=!0,kf&&(kf.textContent=`Ready to Play`),Af&&(Af.style.display=`block`),window.pendingInit&&(console.log(`Assets ready. Processing pending initialization...`),Lp(window.pendingInit),window.pendingInit=null))},setTimeout(()=>{Pf||(console.warn(`Loading timed out. Proceeding with fallbacks.`),Nf.onLoad())},1e4);var Q=new On;Q.name=`car`,Q.position.set(0,0,10),Z.add(Q);var Ff=[];for(let e=0;e<20;e++){let e=new K(new da(.1,5),new Gr({color:16777215,transparent:!0,opacity:.2}));e.rotation.x=-Math.PI/2,e.position.set((Math.random()-.5)*Xd,.08,Q.position.z-Math.random()*200),Z.add(e),Ff.push(e)}var If=new hu(Nf),Lf=new hd;Lf.setDecoderPath(`https://www.gstatic.com/draco/versioned/decoders/1.5.7/`),If.setDRACOLoader(Lf);function Rf(){let e=new On,t=new q({color:11141120,metalness:.8,roughness:.2}),n=new q({color:1118481,metalness:.9,roughness:.1}),r=new q({color:2236962,roughness:.9}),i=new K(new la(2,.5,4.5),t);i.position.set(0,.4,0),i.castShadow=!0,e.add(i);let a=new K(new la(1.6,.6,2),n);a.position.set(0,.9,-.2),a.castShadow=!0,e.add(a);let o=new ua(.35,.35,.3,16);return o.rotateZ(Math.PI/2),[[-1,.35,1.5],[1,.35,1.5],[-1,.35,-1.5],[1,.35,-1.5]].forEach(t=>{let n=new K(o,r);n.position.set(...t),n.castShadow=!0,e.add(n)}),e.name=`carBody`,e}var zf=null,Bf=`https://raw.githubusercontent.com/mrdoob/three.js/master/examples/models/gltf/ferrari.glb`;function Vf(e){let t=new K(new la(.4,.15,.1),new q({color:16777215,emissive:16777215,emissiveIntensity:1}));t.position.set(.8,.5,-2.2),e.add(t);let n=t.clone();n.position.x=-.8,e.add(n);let r=new bo(16774630,12,60,Math.PI/4,.3,1);r.position.set(0,.5,-2.2),r.target.position.set(0,0,-20),e.add(r),e.add(r.target);let i=new K(new la(.5,.2,.1),new q({color:16711680,emissive:16711680,emissiveIntensity:1}));i.position.set(.8,.5,2.2),e.add(i);let a=i.clone();a.position.x=-.8,e.add(a);let o=new K(new ua(.1,0,1.5,8),new q({color:16755200,emissive:16755200,emissiveIntensity:.5,transparent:!0,opacity:.8}));o.position.set(.6,.4,2.5),o.rotation.x=-Math.PI/2,o.name=`exhaust_left`,e.add(o);let s=o.clone();s.position.x=-.6,s.name=`exhaust_right`,e.add(s),Q.add(e),e.name=`playerMesh`,Q.userData.exhL=o,Q.userData.exhR=s,Q.userData.body=e.getObjectByName(`carBody`)||e}If.load(Bf,e=>{zf=e.scene,zf.rotation.y=0,zf.scale.set(1,1,1),zf.rotation.y=0,zf.scale.set(1,1,1);let t=new K(new la(.4,.15,.1),new q({color:16777215,emissive:16777215,emissiveIntensity:1}));t.position.set(.8,.5,-2.2),zf.add(t);let n=t.clone();n.position.x=-.8,zf.add(n);let r=new bo(16774630,12,60,Math.PI/4,.3,1);r.position.set(0,.5,-2.2),r.target.position.set(0,0,-20),zf.add(r),zf.add(r.target);let i=new K(new la(.5,.2,.1),new q({color:16711680,emissive:16711680,emissiveIntensity:1}));i.position.set(.8,.5,2.2),zf.add(i);let a=i.clone();a.position.x=-.8,zf.add(a);let o=new K(new ua(.1,0,1.5,8),new q({color:16755200,emissive:16755200,emissiveIntensity:.5,transparent:!0,opacity:.8}));o.position.set(.6,.4,2.5),o.rotation.x=-Math.PI/2,o.name=`exhaust_left`,zf.add(o);let s=o.clone();s.position.x=-.6,s.name=`exhaust_right`,zf.add(s),zf.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0,e.name.includes(`body`)&&(e.material=new q({color:11141120,metalness:1,roughness:.02,envMapIntensity:2.5})))}),Vf(zf),console.log(`Main Car Loaded`)},void 0,e=>{console.warn(`Failed to load Ferrari model. Using fallback car.`,e),zf=Rf(),Vf(zf),console.log(`Fallback Car Loaded`),Nf.onLoad&&Nf.onLoad()});var Hf=[];function Uf(e){for(;Q.children.length>0;)Q.remove(Q.children[0]);let t,n=tm||[11141120,1981066,657930,5078031,8138002];if(zf){t=zf.clone();let r=n[(e-1)%n.length];t.traverse(e=>{if(e.isMesh&&e.material&&(e.name.toLowerCase().includes(`body`)||e.name.toLowerCase().includes(`paint`)))try{e.material=e.material.clone(),e.material.color&&e.material.color.setHex(r),e.material.roughness=.1,e.material.metalness=.8}catch{console.warn(`Could not apply paint to node:`,e.name)}})}else{let r=[`premium`,`sedan`,`suv`,`premium`,`hatchback`],i=r[(e-1)%r.length];t=nm(i),t.traverse(t=>{t.isMesh&&t.material&&(t.material=new q({color:n[(e-1)%n.length],metalness:1,roughness:.05,envMap:Z.environment,envMapIntensity:2}))})}t.name=`playerMesh`,Q.add(t),Q.userData.exhL=t.getObjectByName(`exhaust_left`),Q.userData.exhR=t.getObjectByName(`exhaust_right`)}Hf.forEach(e=>{e.traverse(e=>{e.isMesh&&e.material&&(e.material.envMap=Z.environment,e.material.envMapIntensity=1.5)})});var Wf=!1,Gf=0,PREP_CITY=null,PREP_TYPES=null;function PREP_THEME(e){let t=[{sky:8894680,fog:13164008,ground:7043674,road:2763309,sign:19750,cars:[657930,9080207,16448250,662587],types:[`sedan`,`hatchback`,`premium`],buildings:[13157564,10137796,14538960]},{sky:16744276,fog:16765091,ground:2972221,road:2368294,sign:7746560,cars:[16762967,16739125,3065014,16252919],types:[`hatchback`,`sedan`,`premium`],buildings:[14262374,16762967,9260643]},{sky:659496,fog:1772106,ground:1316896,road:1118486,sign:1989258,cars:[7103487,4450481,16723555,15659775],types:[`premium`,`suv`,`sedan`],buildings:[1976379,3359829,1013358]},{sky:12187391,fog:14744575,ground:12044195,road:3881526,sign:2446123,cars:[3106448,15909230,16220500,5207853],types:[`suv`,`hatchback`,`sedan`],buildings:[9358054,2203324,16758531]},{sky:1445673,fog:3156835,ground:725803,road:592139,sign:3804323,cars:[16262533,7473591,5032432,16777215],types:[`premium`,`premium`,`suv`],buildings:[2359366,5904538,5032432]}][(Math.max(1,e)-1)%5];PREP_TYPES=t.types,tm=t.cars,Z.background=new G(t.sky),Z.fog&&Z.fog.color&&Z.fog.color.setHex(t.fog),Vd&&Vd.color&&Vd.color.setHex(t.road),Hd&&Hd.color&&Hd.color.setHex(t.ground),wf&&wf.color&&wf.color.setHex(t.sign),PREP_CITY&&Z.remove(PREP_CITY),PREP_CITY=new On,PREP_CITY.name=`level-city-${e}`;let n=new la(1,1,1);for(let r=0;r<36;r++){let i=r%2===0?-1:1,a=18+(r+e)%7*8,o=10+(r+e)%4*4,s=10+(r+e)%3*6,c=t.buildings[r%t.buildings.length],l=new K(n,new q({color:c,roughness:.55,metalness:e>=3?.35:.1}));l.position.set(i*(55+r%5*12),a/2,-80-r*45),l.scale.set(o,a,s),PREP_CITY.add(l)}Z.add(PREP_CITY)};Af.onclick=()=>{Fd(),jd.state===`suspended`&&jd.resume(),jf.style.display=`none`,Wf=!0,Dp=Date.now()};function Kf(e=!1){console.log(`Resetting Game. Level:`,xp,`KeepScore:`,e),Wf=!1,jp=!1,Xf=0,ap=0,Q.position.set(0,0,10),Q.rotation.set(0,0,0),kp=1,PREP_THEME(xp),Uf(xp),Op=Cp[xp-1],sm.set(0,6,14),Mp&&=(Z.remove(Mp),null),Np&&=(Z.remove(Np),null),document.querySelectorAll(`div`).forEach(e=>{(e.textContent===`CONGRATULATIONS`||e.textContent===`MISSION COMPLETE`)&&e.remove()}),e||(Ep=0,Gf=0),wp=0,Tp=0,Ap=3,dm.clear();let t=1+(xp-1)*.12,n=Math.min(6+(xp-1),12);Yp.forEach(e=>Z.remove(e.mesh)),Yp.length=0;for(let e=0;e<n;e++)im(-100-e*40);Yp.forEach(e=>{e.speed*=t}),Om(),km(),pp.textContent=e?Ep.toLocaleString():`0`,hp&&(hp.textContent=xp),gp&&(gp.textContent=wp),_p&&(_p.textContent=Sp[xp-1]),vp&&(vp.style.width=`0%`);let r=document.getElementById(`game-over-overlay`);r&&r.remove();let i=document.getElementById(`win-overlay`);i&&i.remove(),Mf.style.display=`none`,setTimeout(()=>{Wf=!0,Dp=Date.now()},100)}function qf(){let e=new On,t=new q({color:10263708,metalness:.8,roughness:.3}),n=new K(new ua(.07,.1,9,6),t);n.position.y=4.5,e.add(n);let r=new K(new la(2.5,.1,.1),t);r.position.set(1.25,8.8,0),e.add(r);let i=new q({color:15263968,roughness:.3}),a=new K(new la(.7,.2,.4),i);return a.position.set(2.5,8.75,0),e.add(a),e}for(let e=0;e<75;e++){let t=e%2==0?-1:1,n=qf();n.position.set(t*(Xd/2+4.5),0,-e*40-10),t===1&&(n.rotation.y=Math.PI),Z.add(n)}function Jf(){let e=new On,t=new q({color:8947840,roughness:.7}),n=new K(new la(.3,10,.3),t);n.position.y=5,e.add(n);let r=new K(new la(8,4,.3),t);r.position.y=10.5,e.add(r);let i=new q({color:16117995,roughness:.8}),a=new K(new da(7.8,3.8),i);return a.position.set(0,10.5,.16),e.add(a),e}[-90,-180,-270,-360,-450,-540].forEach((e,t)=>{let n=t%2==0?-1:1,r=Jf();r.position.set(n*28,0,e),r.rotation.y=n===1?-.3:.3,Z.add(r)});var Yf=new q({color:7048282,roughness:1});for(let e=0;e<12;e++){let t=35+Math.random()*25,n=new K(new fa(t,12,8),Yf),r=e%2==0?1:-1;n.position.set(r*(120+Math.random()*80),-t+5,-200-e*120),Z.add(n)}new vs(Ad).compileEquirectangularShader(),new no().setPath(`https://raw.githubusercontent.com/mrdoob/three.js/master/examples/textures/cube/Park3Med/`).load([`px.jpg`,`nx.jpg`,`py.jpg`,`ny.jpg`,`pz.jpg`,`nz.jpg`],e=>{Z.environment=e,Z.background=e,Z.backgroundBlurriness=.5});var $={w:!1,a:!1,s:!1,d:!1,space:!1},Xf=0,Zf=.72,Qf=1.15,$f=.008,ep=.018,tp=.004,np=.02,rp=.004,ip=.85,ap=0,op=.1,sp=-Xd/2+1.2,cp=Xd/2-1.2,lp=0,up=120;Wf=!1;var dp=document.getElementById(`speedo-value`),fp=document.getElementById(`stat-gear`),pp=document.getElementById(`stat-score`),mp=document.getElementById(`stat-time`),hp=document.getElementById(`stat-level`),gp=document.getElementById(`stat-unit-current`),_p=document.getElementById(`stat-unit-total`),vp=document.getElementById(`progress-bar`),yp=document.getElementById(`pedal-accel`),bp=document.getElementById(`pedal-brake`),xp=1,Sp=[10,20,30,40,50],Cp=[300,600,900,1500,2100],wp=0,Tp=0,Ep=0,Dp=Date.now(),Op=0,kp=1,Ap=3,jp=!1,Mp=null,Np=null,Pp=0,Fp=!1,Ip=[];window.pendingInit=null;function Lp(e){console.log(`Processing Init Data:`,e);let t=e.questions,n=e.courseId||`default`,r=parseInt(e.startLevel||new URLSearchParams(window.location.search).get(`level`),10);if(window.currentCourseId=n,!Number.isNaN(r)&&r>=1){xp=Math.min(r,5);let e=document.getElementById(`loading-status`);e&&(e.textContent=`STARTING AT LEVEL ${xp}`)}else{let e=localStorage.getItem(`prepdrive_progression_${n}`);if(e){xp=parseInt(e);let t=document.getElementById(`loading-status`);t&&(t.textContent=`RESTORING PROGRESS: LEVEL ${xp}`)}else xp=1}t&&t.length>0&&(Tf.basic=t,Tf.advanced=t),Kf(!0)}window.addEventListener(`message`,e=>{if(e.data.type===`INIT_GAME`){if(!Pf){window.pendingInit=e.data,console.log(`Message received but assets still loading. Initialization deferred.`);return}Lp(e.data)}}),window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();(t===`w`||t===`arrowup`)&&($.w=!0,yp.classList.add(`active`)),(t===`s`||t===`arrowdown`)&&($.s=!0,bp.classList.add(`active`)),(t===`a`||t===`arrowleft`)&&($.a=!0),(t===`d`||t===`arrowright`)&&($.d=!0),(t===` `||t===`space`)&&($.space=!0)}),window.addEventListener(`keyup`,e=>{let t=e.key.toLowerCase();(t===`w`||t===`arrowup`)&&($.w=!1,yp.classList.remove(`active`)),(t===`s`||t===`arrowdown`)&&($.s=!1,bp.classList.remove(`active`)),(t===`a`||t===`arrowleft`)&&($.a=!1),(t===`d`||t===`arrowright`)&&($.d=!1),(t===` `||t===`space`)&&($.space=!1)}),yp.addEventListener(`touchstart`,e=>{e.preventDefault(),$.w=!0,yp.classList.add(`active`)}),yp.addEventListener(`touchend`,()=>{$.w=!1,yp.classList.remove(`active`)}),bp.addEventListener(`touchstart`,e=>{e.preventDefault(),$.s=!0,bp.classList.add(`active`)}),bp.addEventListener(`touchend`,()=>{$.s=!1,bp.classList.remove(`active`)});var Rp=document.getElementById(`steering-zone`),zp=document.getElementById(`joystick-knob`),Bp=document.getElementById(`steering-wheel-icon`),Vp=!1,Hp=0,Up=10,Wp=55;function Gp(e){return Math.max(-Wp,Math.min(Wp,e-Hp))}function Kp(e){zp.style.transform=`translate(calc(-50% + ${e}px), -50%)`;let t=e/Wp*90;Bp.style.transform=`rotate(${t}deg)`,Math.abs(e)<Up?($.a=!1,$.d=!1):e<0?($.a=!0,$.d=!1):($.d=!0,$.a=!1)}function qp(){Vp=!1,zp.style.transform=`translate(-50%, -50%)`,Bp.style.transform=`rotate(0deg)`,$.a=!1,$.d=!1}Rp.addEventListener(`touchstart`,e=>{e.preventDefault(),Vp=!0,Hp=e.touches[0].clientX,Kp(0)},{passive:!1}),Rp.addEventListener(`touchmove`,e=>{e.preventDefault(),Vp&&Kp(Gp(e.touches[0].clientX))},{passive:!1}),Rp.addEventListener(`touchend`,qp),Rp.addEventListener(`touchcancel`,qp),Rp.addEventListener(`mousedown`,e=>{Vp=!0,Hp=e.clientX,Kp(0)}),window.addEventListener(`mousemove`,e=>{Vp&&Kp(Gp(e.clientX))}),window.addEventListener(`mouseup`,()=>{Vp&&qp()});var Jp=document.getElementById(`nitro-btn`);Jp.addEventListener(`touchstart`,e=>{e.preventDefault(),$.space=!0,Jp.classList.add(`active`)}),Jp.addEventListener(`touchend`,()=>{$.space=!1,Jp.classList.remove(`active`)}),Jp.addEventListener(`mousedown`,()=>{$.space=!0,Jp.classList.add(`active`)}),Jp.addEventListener(`mouseup`,()=>{$.space=!1,Jp.classList.remove(`active`)}),yp.addEventListener(`mousedown`,()=>{$.w=!0,yp.classList.add(`active`)}),bp.addEventListener(`mousedown`,()=>{$.s=!0,bp.classList.add(`active`)}),window.addEventListener(`mouseup`,()=>{$.w=!1,$.s=!1,yp.classList.remove(`active`),bp.classList.remove(`active`)});var Yp=[],Xp=new q({color:328965,roughness:.1,metalness:1}),Zp=new Gr({color:1118481}),Qp=new Gr({color:16777215}),$p=new Gr({color:11141120}),em=new ua(.35,.35,.28,8),tm=Object.values({black:657930,silver:9080207,white:16448250,grey:3816768,blue:662587,red:4852234});function nm(e=`sedan`){let t=new On,n=2,r=.8,i=4,a=.6,o=2,s=-.2;e===`premium`?(n=2.1,r=.7,i=4.6,a=.5,o=2.2,s=-.1):e===`suv`?(n=2.2,r=1.1,i=4.8,a=.7,o=2.6,s=.2):e===`hatchback`&&(n=1.9,r=.9,i=3.6,a=.6,o=2,s=.4);let c=tm[Math.floor(Math.random()*tm.length)],l=new q({color:c,metalness:.9,roughness:.2,envMapIntensity:1}),u=new K(new la(n,r,i),l);u.position.set(0,r/2+.3,0),t.add(u);let d=new K(new la(n*.85,a,o),Xp);d.position.set(0,r+.3+a/2-.05,s),t.add(d);let f=[];[{x:n/2,y:.35,z:i/2-.7},{x:-n/2,y:.35,z:i/2-.7},{x:n/2,y:.35,z:-i/2+.7},{x:-n/2,y:.35,z:-i/2+.7}].forEach(e=>{let n=new On,r=new K(em,Zp);r.rotation.z=Math.PI/2,n.add(r),n.position.set(e.x,e.y,e.z),t.add(n),f.push(n)});let p=new K(new da(.4,.1),Qp);p.position.set(n/2-.35,r*.8+.3,-i/2-.01),t.add(p);let m=p.clone();m.position.x*=-1,t.add(m);let h=new K(new da(.5,.12),$p);h.position.set(n/2-.4,r*.8+.3,i/2+.01),t.add(h);let g=h.clone();return g.position.x*=-1,t.add(g),t.userData={type:e,width:n,length:i,wheels:f},t}var rm=8;function im(e){let t=[-5.25,-1.75,1.75,5.25],n=t[Math.floor(Math.random()*t.length)],r,i=`sedan`;if(Hf.length>0&&Math.random()>.5){let e=Hf[Math.floor(Math.random()*Hf.length)];r=e.clone(),i=e.userData.type||`sedan`,r.rotation.y=Math.PI}else{let e=PREP_TYPES||[`sedan`,`suv`,`hatchback`,`premium`];i=e[Math.floor(Math.random()*e.length)],r=nm(i)}r.position.set(n,0,e),Z.add(r);let a=.12+Math.random()*.1;i===`suv`&&(a*=.7),i===`premium`&&(a*=1.2),Yp.push({mesh:r,speed:a,isStatic:!1,type:i})}for(let e=0;e<rm;e++)im(-40-e*40);var am=new On,om=new K(new ua(8,8,80,8,1,!0,0,Math.PI),new Gr({color:1710618,side:1}));om.rotation.z=Math.PI/2,om.rotation.y=Math.PI/2,am.add(om),am.position.set(0,0,-150),Z.add(am);var sm=new V(0,6,14),cm=new V(0,2,-10),lm=new V,um=new V,dm=new Set,fm=0,pm=new V,mm=new V,hm={score:-1,time:``,progress:-1},gm=document.createElement(`div`);gm.className=`checkpoint-notify`,gm.style.display=`none`,document.body.appendChild(gm);function _m(){try{if(fm+=.016,Wf){let e=$.space&&Xf>.1,t=e?Qf:Zf,n=e?ep:$f;jp&&(t=.35),Xf=$.w?Math.min(Xf+n,t):$.s?Math.max(Xf-np,0):Math.max(Xf-tp,0),Np&&!jp&&(Xf=Math.max(Xf*.985,.1));let r=0;$.a?(ap=Math.max(ap-rp,-op),lp=jt.lerp(lp,-up,.12)):$.d?(ap=Math.min(ap+rp,op),lp=jt.lerp(lp,up,.12)):(ap*=ip,lp=jt.lerp(lp,0,.08)),Q.position.x+=ap*(Xf*1.2+.6)*6,Q.position.x=jt.clamp(Q.position.x,sp,cp),r=-ap*.45,Q.rotation.z=jt.lerp(Q.rotation.z,r,.1),Q.rotation.y=jt.lerp(Q.rotation.y,-ap*.25,.1),Q.position.z-=Xf*2,Q.position.z<-9e3&&(Q.position.z=10,dm.clear());let i=e?72:60;if(Math.abs(kd.fov-i)>.1&&(kd.fov=jt.lerp(kd.fov,i,.08),kd.updateProjectionMatrix()),dp.textContent=Math.round(Xf*240).toString().padStart(1,`0`),fp.textContent=Xf>.01?Xf>.6?`5`:`3`:`N`,window.audioData){let{engineOsc:t,engineFilter:n,engineGain:r,windFilter:i,windGain:a}=window.audioData,o=40+Xf*120+(e?40:0);t.frequency.setTargetAtTime(o,jd.currentTime,.1),n.frequency.setTargetAtTime(400+Xf*800,jd.currentTime,.1),r.gain.setTargetAtTime($.w?.15:.08,jd.currentTime,.2),i.frequency.setTargetAtTime(100+Xf*1500,jd.currentTime,.1),a.gain.setTargetAtTime(Xf*.15,jd.currentTime,.1)}let a=(Date.now()-Dp)/1e3,o=Math.max(0,Cp[xp-1]-a);o<=0&&(Wf=!1,Am(`MISSION FAILED // TIME EXPIRED`));let s=`${Math.floor(o/60).toString().padStart(2,`0`)}:${Math.floor(o%60).toString().padStart(2,`0`)}`;hm.time!==s&&(mp.textContent=s,mp.style.color=o<30?`#ff0033`:`#fff`,o<10?mp.style.animation=`pulse 0.5s infinite`:mp.style.animation=`none`,hm.time=s);let c=Math.min(Math.abs(Q.position.z)/Yd*100,100),l=Math.floor(c);hm.progress!==l&&(vp.style.width=`${c}%`,hm.progress=l),hm.score!==Ep&&(pp.textContent=Ep.toLocaleString(),hm.score=Ep),hp&&(hp.textContent=xp),c>=100&&Em();let u=Q.userData.exhL,d=Q.userData.exhR;if(u&&d&&u.material&&d.material){let e=$.space&&Xf>.1,t=$.w?(1+Math.sin(fm*30)*.3)*(e?2:1):.2;u.scale.set(t,t,t),d.scale.set(t,t,t);let n=e?8965375:16755200;u.userData.lastColor!==n&&(u.material.color.setHex(n),d.material.color.setHex(n),u.material.emissive.setHex(n),d.material.emissive.setHex(n),u.userData.lastColor=n),u.material.emissiveIntensity=$.w?(e?4:2)+Math.sin(fm*50)*.5:.5,d.material.emissiveIntensity=u.material.emissiveIntensity}Yp.forEach(e=>{if(e.mesh.position.z-=e.speed,e.mesh.userData.wheels&&e.speed>0){let t=e.speed*2;for(let n=0;n<e.mesh.userData.wheels.length;n++)e.mesh.userData.wheels[n].children[0].rotation.x+=t}if(e.mesh.position.z>Q.position.z+25){e.mesh.position.z=Q.position.z-300;let t=Of.find(e=>!dm.has(Of.indexOf(e)));t&&Math.abs(e.mesh.position.z-t.z)<40&&(e.mesh.position.z-=60);let n=[-5.25,-1.75,1.75,5.25];e.mesh.position.x=n[Math.floor(Math.random()*n.length)]}let t=Math.abs(Q.position.x-e.mesh.position.x),n=Math.abs(Q.position.z-e.mesh.position.z),r=e.mesh.userData.width||2,i=e.mesh.userData.length||4;t<(2+r)/2-.2&&n<(4.4+i)/2-.2&&!jp&&(Fp?(Fp=!1,Pp=0,document.getElementById(`shield-indicator`).style.opacity=`0.3`,jm(e.mesh.position.clone(),15381256),e.mesh.position.y=-100,Id(150,`sawtooth`,.5)):(Wf=!1,Id(100,`square`,.5),Ap--,Om(),Ap<=0?Am():(Mf.style.display=`flex`,setTimeout(()=>{Q.position.x=0,Xf=0,Wf=!0,Mf.style.display=`none`},2e3))))}),Of.forEach((e,t)=>{!dm.has(t)&&Math.abs(Q.position.z-e.z)<5&&wm(t),e.curtain&&(e.curtain.material.opacity=.05+Math.sin(fm*8+t)*.05)}),Ff.forEach(e=>{e.position.z+=Xf*5,e.position.z>Q.position.z+20&&(e.position.z=Q.position.z-200,e.position.x=(Math.random()-.5)*(Xd-2)),e.scale.y=Xf*5+.1,e.material.opacity=Xf*.3}),Xf>.1&&(Ep+=Math.floor(Xf*5))}let e=0,t=0;if(Wf&&Xf>1.2&&(e=(Math.random()-.5)*(Xf*.05),t=(Math.random()-.5)*(Xf*.05)),Mf.style.display===`flex`&&(e=(Math.random()-.5)*.6,t=(Math.random()-.5)*.6),pm.set(Q.position.x*.5+e,Q.position.y+sm.y+t,Q.position.z+sm.z),mm.set(Q.position.x*.7,Q.position.y+cm.y,Q.position.z+cm.z),lm.lerp(pm,.08),um.lerp(mm,.12),kd.position.copy(lm),kd.lookAt(um),jp&&Mp&&Wf&&Math.abs(Q.position.z-Mp.position.z)<12&&Cm(),xm(),Np&&Np.userData.states){let e=Np.userData.states,t=new W,n=new Mt,r=new V(1,1,1);e.forEach((e,i)=>{e.pos.y-=e.speed,e.rot.x+=e.spin,e.rot.y+=e.spin,e.pos.x+=Math.sin(fm+e.wobble)*.04,e.pos.z+=Math.cos(fm+e.wobble)*.02,e.pos.y<0&&(e.pos.y=25),n.setFromEuler(e.rot),t.compose(e.pos,n,r),Np.setMatrixAt(i,t)}),Np.instanceMatrix.needsUpdate=!0}zd.render()}catch(e){console.error(`Critical Engine Error:`,e),Wf=!1}}var vm={sky:new G(8894680),fog:new G(13164008),ambient:15266040,ambientInt:.8,hemiSky:14215416,hemiGround:4013357,hemiInt:.6,dir:16774630,dirInt:1.8},ym={sky:new G(16743252),fog:new G(16757380),ambient:16765370,ambientInt:.6,hemiSky:16752762,hemiGround:2956573,hemiInt:.4,dir:16729344,dirInt:1.2},bm={sky:new G(657946),fog:new G(1710638),ambient:2763338,ambientInt:.2,hemiSky:1450302,hemiGround:996448,hemiInt:.2,dir:4450481,dirInt:.5};function xm(){let e;e=xp===1?vm:xp===2?ym:bm,Z.background&&Z.background.isColor&&Z.background.lerp(e.sky,.01),Z.fog&&Z.fog.color&&Z.fog.color.lerp(e.fog,.01),Wd&&(Wd.color.lerp(new G(e.ambient),.01),Wd.intensity=jt.lerp(Wd.intensity,e.ambientInt,.01)),Gd&&(Gd.color.lerp(new G(e.hemiSky),.01),Gd.groundColor.lerp(new G(e.hemiGround),.01),Gd.intensity=jt.lerp(Gd.intensity,e.hemiInt,.01)),Kd&&(Kd.color.lerp(new G(e.dir),.01),Kd.intensity=jt.lerp(Kd.intensity,e.dirInt,.01))}function Sm(e){Mp&&Z.remove(Mp);let t=new On,n=new la(2,12,2),r=new la(Xd+4,1.5,2),i=new q({color:1118481,roughness:.2,metalness:.8}),a=new K(n,i);a.position.set(-Xd/2-1,6,0),t.add(a);let o=new K(n,i);o.position.set(Xd/2+1,6,0),t.add(o);let s=new K(r,i);s.position.set(0,11,0),t.add(s);let c=new la(Xd+4,.5,.5),l=new q({color:3355443,metalness:.8});for(let e=0;e<3;e++){let n=new K(c,l);n.position.set(0,10+e*1,.3),t.add(n)}let u=new K(new da(Xd-2,1.2),new Gr({color:4450481,transparent:!0,opacity:.95}));u.position.set(0,11,1.05),t.add(u);let d=new ua(.2,.2,1.5),f=new q({color:0}),p=new Gr({color:16777215});for(let e=0;e<5;e++){let n=new K(d,f);n.position.set(-Xd/2-.5,.75,-10-e*8),t.add(n);let r=new K(d,f);r.position.set(Xd/2+.5,.75,-10-e*8),t.add(r);let i=new K(new fa(.1),p);i.position.set(0,.8,0),n.add(i.clone()),r.add(i.clone())}let m=new da(Xd,.4),h=new Gr({color:16777215,transparent:!0,opacity:.8});for(let e=0;e<3;e++){let n=new K(m,h);n.rotation.x=-Math.PI/2,n.position.set(0,.06,-5+e*1.5),t.add(n)}let g=new K(new da(Xd,60),new Gr({color:4450481,transparent:!0,opacity:.08,side:2}));g.rotation.x=-Math.PI/2,g.position.set(0,.05,-10),t.add(g),t.position.set(0,0,e),Z.add(t),Mp=t,jp=!0,Yp.forEach(t=>{t.mesh.position.z<Q.position.z&&t.mesh.position.z>e-50&&(Z.remove(t.mesh),t.mesh.position.y=-100)})}function Cm(){if(!jp)return;jp=!1,Id(660,`sine`,.3),setTimeout(()=>Id(880,`sine`,.3),150),setTimeout(()=>Id(1100,`sine`,.3),300);let e=new Oi(new da(.12,.2),new Gr({color:15794164,side:2,transparent:!0,opacity:.6,blending:2}),200),t=new W,n=new V,r=new un,i=new Mt,a=new V(1,1,1),o=[];for(let s=0;s<200;s++)n.set((Math.random()-.5)*40,15+Math.random()*20,Q.position.z-30+(Math.random()-.5)*40),r.set(Math.random()*Math.PI,Math.random()*Math.PI,0),i.setFromEuler(r),t.compose(n,i,a),e.setMatrixAt(s,t),o.push({pos:n.clone(),rot:r.clone(),speed:.05+Math.random()*.1,spin:(Math.random()-.5)*.1,wobble:Math.random()*Math.PI});e.instanceMatrix.needsUpdate=!0,Z.add(e),Np=e,Np.userData.states=o;let s=document.createElement(`div`);s.style.cssText=`position:fixed; top:40%; left:50%; transform:translate(-50%, -50%); color:#fff; font-weight:900; font-size:4rem; letter-spacing:10px; text-transform:uppercase; z-index:3000; animation: pulse 1.2s infinite; text-shadow: 0 0 30px #43E8B1; pointer-events:none; opacity: 0; transition: opacity 0.8s;`,s.textContent=`CONGRATULATIONS`,document.body.appendChild(s),requestAnimationFrame(()=>{s.style.opacity=`1`}),sm.z;let c=setInterval(()=>{sm.z=Math.min(sm.z+.1,22),sm.y=Math.min(sm.y+.05,9)},16);setTimeout(()=>{s.style.opacity=`0`,s.style.transition=`opacity 1.5s`,clearInterval(c);let e=setInterval(()=>{sm.z=Math.max(sm.z-.2,14),sm.y=Math.max(sm.y-.1,6),sm.z===14&&sm.y===6&&clearInterval(e)},16);setTimeout(()=>{s.remove(),Np&&=(Z.remove(Np),null),Mp&&=(Z.remove(Mp),null),Dm()},1500)},2e3)}lm.copy(Q.position).add(sm),um.copy(Q.position).add(cm),Ad.setAnimationLoop(_m);function wm(e){dm.add(e),kp=Math.max(kp,e+2),Id(880,`sine`,.2);let t=Math.min(.2+(xp-1)*.15,.7),n=Math.random()<t?Tf.advanced:Tf.basic,r=n[Math.floor(Math.random()*n.length)];Tm(e,r)}function Tm(e,t){Wf=!1;let n=document.createElement(`div`);n.id=`question-modal`,n.className=`overlay-active`,n.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.85);display:flex;align-items:center;justify-content:center;z-index:2000;`;let r=``;t.a.forEach((e,t)=>{r+=`<button class="answer-btn" data-idx="${t}" style="width:100%; padding:1.2rem 1.5rem; margin:0.4rem 0; background:rgba(255,255,255,0.05); color:#f4f4f5; border:1px solid rgba(255,255,255,0.1); border-radius:16px; font-size:1.1rem; cursor:pointer; font-weight:500; text-align:left; transition:all 0.2s; font-family:'Inter', sans-serif;" onmouseover="this.style.background='rgba(255,255,255,0.1)'" onmouseout="this.style.background='rgba(255,255,255,0.05)'">${e}</button>`}),n.innerHTML=`
        <div class="brutalist-panel" style="width: 90%; max-width: 600px; padding: 2.5rem; border-color: #${Ef[e%Ef.length].toString(16).padStart(6,`0`)}; border-radius: 24px; background: rgba(24,24,27,0.95); backdrop-filter: blur(10px); box-shadow: 0 4px 30px rgba(0,0,0,0.5);">
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.5rem; border-bottom:1px solid rgba(255,255,255,0.1); padding-bottom:1rem;">
                <span style="font-size:0.75rem; font-weight:600; color:#10b981; letter-spacing:1.5px; text-transform:uppercase;">Question Checkpoint</span>
                <span style="font-size:0.75rem; font-weight:600; color:#a1a1aa;">${e+1} / ${Sp[xp-1]}</span>
            </div>
            <h2 style="color:#f4f4f5; font-size:1.4rem; margin-bottom:2rem; font-family:'Inter', sans-serif; line-height:1.5; font-weight:600;">${t.q}</h2>
            <div style="display:grid; grid-template-columns:1fr; gap:0.5rem;">
                ${r}
            </div>
            <div style="margin-top:1.5rem; font-size:0.75rem; color:#a1a1aa; font-weight:500; text-align:center;">
                Choose the correct answer to continue
            </div>
        </div>
    `,document.body.appendChild(n),n.querySelectorAll(`.answer-btn`).forEach(e=>{e.onclick=()=>{if(parseInt(e.getAttribute(`data-idx`))===t.c){if(e.style.background=`#43E8B1`,e.style.color=`#000`,Ep+=2500,Gf++,wp++,Pp++,Pp>=3&&!Fp&&(Fp=!0,document.getElementById(`shield-indicator`).style.opacity=`1`,Id(600,`sine`,.4)),jm(Q.position.clone(),4450481),Id(1200,`sine`,.3),gp&&(gp.textContent=wp),vp){let e=Sp[xp-1];vp.style.width=`${Math.min(100,wp/e*100)}%`}if(gm.textContent=`CORRECT // MISSION RESUMED`,gm.style.color=`#43E8B1`,Xf=.4,wp>=Sp[xp-1]){setTimeout(()=>{n.remove(),Sm(Q.position.z-150),gm.textContent=`FINAL UNIT VALIDATED // PROCEED TO ARRIVAL ZONE`,gm.style.color=`#43E8B1`,gm.style.display=`block`,Wf=!0,setTimeout(()=>gm.style.display=`none`,3e3)},1e3);return}}else e.style.background=`#ff0033`,Ep-=500,Ap--,Tp++,Pp=0,Fp=!1,document.getElementById(`shield-indicator`).style.opacity=`0.3`,Ip.push(t),jm(Q.position.clone(),16711731),Om(),Id(150,`sawtooth`,.4),gm.textContent=`INCORRECT // REDUCED SPEED MODE`,gm.style.color=`#ff0033`,Xf=.1;gm.style.display=`block`,setTimeout(()=>{n.remove(),Ap<=0?Am():Wf=!0,setTimeout(()=>gm.style.display=`none`,2e3)},1e3)}})}function Em(){Wf=!1;let e=document.createElement(`div`);e.id=`win-overlay`,e.className=`overlay-active`,e.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.8);display:flex;align-items:center;justify-content:center;z-index:1000;`,e.innerHTML=`
        <div class="brutalist-panel" style="padding: 3rem; text-align: center; border-color: #43E8B1; max-width: 500px;">
            ...
            <div style="margin: 2rem 0; text-align: left; background: rgba(255,255,255,0.05); padding: 1.5rem; border: 1px solid rgba(255,255,255,0.1);">
                ...
                <div style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                    ...
                    <span style="color: #fff; font-family: monospace;">${Ep.toLocaleString()}</span>
                </div>
                <div style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                ...
                <div style="display: flex; justify-content: space-between;">
                    ...
                    <span style="color: #43E8B1; font-family: monospace;">${Math.round(Gf/(Gf+Tp)*100)}%</span>
                </div>
            </div>
    ...
    `,document.body.appendChild(e),window.parent.postMessage({type:`GAME_OVER`,success:true,score:Ep,awards:xp,failedQuestions:Ip},`*`),Wf=!1}function Dm(){Wf=!1;let e=document.createElement(`div`);e.id=`level-complete-overlay`,e.className=`overlay-active`,e.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.92);display:flex;align-items:center;justify-content:center;z-index:2500;`,e.innerHTML=`
        <div class="brutalist-panel" style="padding: 3rem; text-align: center; border-color: rgba(67, 232, 177, 0.3); border-radius: 24px; max-width: 550px; background: rgba(24,24,27,0.95); backdrop-filter: blur(10px);">
            <p style="color: #10b981; font-weight: 600; letter-spacing: 2px; margin: 0; font-size: 0.8rem; text-transform: uppercase;">Mission Debrief // Level ${xp}</p>
            <h1 style="color: #f4f4f5; font-size: 3rem; margin: 0.5rem 0 2rem 0; font-weight: 600; letter-spacing: -1px;">Level Complete</h1>
            
            <div style="margin-bottom: 2.5rem; text-align: left; background: rgba(255,255,255,0.03); padding: 2rem; border-radius: 16px; border: 1px solid rgba(255,255,255,0.05);">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                    <div>
                        ...
                        <span style="color: #43E8B1; font-family: monospace; font-weight: 900; font-size: 1.4rem;">${wp}</span>
                    </div>
                    <div>
                        ...
                        <span style="color: #ff0033; font-family: monospace; font-weight: 900; font-size: 1.4rem;">${Tp}</span>
                    </div>
                </div>
                ...
                <div style="margin-top: 1.5rem; padding-top: 1rem; border-top: 1px solid rgba(255,255,255,0.1);">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                        ...
                        <span style="color: #6C63FF; font-family: monospace; font-weight: 900;">+${(xp*1e3).toLocaleString()}</span>
                    </div>
                    ${Tp===0?`
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 1rem; border-top: 1px solid rgba(255,255,255,0.2); padding-top: 1rem;">
                        ...
                        <span style="color: #fff; font-family: monospace; font-weight: 900; font-size: 1.5rem;">${(Ep+xp*1e3+(Tp===0?5e3:0)).toLocaleString()}</span>
                    </div>
                </div>
            </div>

            <div style="display: flex; gap: 1rem;">
                <button id="replay-level-btn" style="flex: 1; padding: 1rem; background: transparent; color: #f4f4f5; border: 1px solid rgba(255,255,255,0.2); cursor: pointer; font-weight: 600; border-radius: 9999px; transition: all 0.2s;">Replay</button>
                <button id="next-level-btn" style="flex: 2; padding: 1.2rem; background: #fff; color: #18181b; border: none; cursor: pointer; font-weight: 600; border-radius: 9999px; transition: all 0.2s;">Next Level</button>
            </div>
        </div>
    `,document.body.appendChild(e),document.getElementById(`replay-level-btn`).onclick=()=>{e.remove(),Kf(!0)},document.getElementById(`next-level-btn`).onclick=()=>{Ep+=xp*1e3,Tp===0&&(Ep+=5e3),e.remove(),xp>=5?(window.currentCourseId&&localStorage.removeItem(`prepdrive_progression_${window.currentCourseId}`),Em()):(xp++,window.currentCourseId&&localStorage.setItem(`prepdrive_progression_${window.currentCourseId}`,xp),Kf(!0))}}function Om(){document.querySelectorAll(`.lives-container .heart`).forEach((e,t)=>{t>=Ap?e.classList.add(`lost`):e.classList.remove(`lost`)})}function km(){document.querySelectorAll(`#mastery-badges .heart`).forEach((e,t)=>{t<xp-1?(e.style.opacity=`1`,e.style.background=`#43E8B1`,e.style.boxShadow=`0 0 10px #43E8B1`):(e.style.opacity=`0.2`,e.style.background=`#fff`,e.style.boxShadow=`none`)})}function Am(){Wf=!1;let e=document.createElement(`div`);e.id=`game-over-overlay`,e.className=`overlay-active`,e.innerHTML=`
        <div class="brutalist-panel" style="padding: 3rem; text-align: center; border-radius: 24px; border: 1px solid rgba(255,255,255,0.1); background: rgba(24,24,27,0.95); backdrop-filter: blur(10px); box-shadow: 0 4px 30px rgba(0,0,0,0.5);">
            <h1 style="color: #ef4444; font-size: 3rem; margin: 0; font-weight: 600; letter-spacing: -1px;">Mission Failed</h1>
            <p style="color: #a1a1aa; margin: 1rem 0; font-size: 1rem;">Final Score: <span style="color: #f4f4f5; font-family: monospace; font-weight: 600;">${Ep}</span></p>
            <button id="retry-btn" style="padding: 1rem 2.5rem; background: #fff; color: #18181b; border: none; cursor: pointer; font-weight: 600; border-radius: 9999px; transition: all 0.2s;">Exit Simulation</button>
        </div>
    `,document.body.appendChild(e),document.getElementById(`retry-btn`).onclick=()=>{e.remove()},window.parent.postMessage({type:`GAME_OVER`,success:false,score:Ep,awards:xp>1?xp-1:0,failedQuestions:Ip},`*`)}function jm(e,t){let n=new jr,r=new Float32Array(90),i=[];for(let t=0;t<30;t++)r[t*3]=e.x,r[t*3+1]=e.y+2,r[t*3+2]=e.z,i.push({x:(Math.random()-.5)*2,y:(Math.random()-.5)*2,z:(Math.random()-.5)*2});n.setAttribute(`position`,new gr(r,3));let a=new Zi({color:t,size:.8,transparent:!0,opacity:1,blending:2}),o=new na(n,a);Z.add(o);let s=0,c=setInterval(()=>{s+=.05;let e=o.geometry.attributes.position;for(let t=0;t<30;t++)e.array[t*3]+=i[t].x,e.array[t*3+1]+=i[t].y,e.array[t*3+2]+=i[t].z;e.needsUpdate=!0,a.opacity=1-s,s>=1&&(clearInterval(c),Z.remove(o))},16)}window.addEventListener(`resize`,()=>{kd.aspect=window.innerWidth/window.innerHeight,kd.updateProjectionMatrix(),Ad.setSize(window.innerWidth,window.innerHeight),zd.setSize(window.innerWidth,window.innerHeight)}),Ad.setAnimationLoop(_m);
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Cs(e,t,n){let r=new Float32Array(ls),i=new H(0,1,0);return new ba({name:`SphericalGaussianBlur`,defines:{n:ls,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Es(),fragmentShader:`
...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){let e=new Worker(this.workerSourceURL);e._callbacks={},e._taskCosts={},e._taskLoad=0,e.postMessage({type:`init`,decoderConfig:this.decoderConfig}),e.onmessage=function(t){let n=t.data;switch(n.type){case`decode`:e._callbacks[n.id].resolve(n);break;case`error`:e._callbacks[n.id].reject(n);break;default:console.error(`THREE.DRACOLoader: Unexpected message, "`+n.type+`"`)}},this.workerPool.push(e)}else this.workerPool.sort(function(e,t){return e._taskLoad>t._taskLoad?-1:1});let n=this.workerPool[this.workerPool.length-1];return n._taskCosts[e]=t,n._taskLoad+=t,n})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log(`Task load: `,this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==``&&URL.revokeObjectURL(this.workerSourceURL),this}};function gd(){let e,t;onmessage=function(r){let i=r.data;switch(i.type){case`init`:e=i.decoderConfig,t=new Promise(function(t){e.onModuleLoaded=function(e){t({draco:e})},DracoDecoderModule(e)});break;case`decode`:let r=i.buffer,a=i.taskConfig;t.then(e=>{let t=e.draco,o=new t.Decoder;try{let e=n(t,o,new Int8Array(r),a),s=e.attributes.map(e=>e.array.buffer);e.index&&s.push(e.index.array.buffer),self.postMessage({type:`decode`,id:i.id,geometry:e},s)}catch(e){console.error(e),self.postMessage({type:`error`,id:i.id,error:e.message})}finally{t.destroy(o)}});break}};function n(e,t,n,a){let o=a.attributeIDs,s=a.attributeTypes,c,l,u=t.GetEncodedGeometryType(n);if(u===e.TRIANGULAR_MESH)c=new e.Mesh,l=t.DecodeArrayToMesh(n,n.byteLength,c);else if(u===e.POINT_CLOUD)c=new e.PointCloud,l=t.DecodeArrayToPointCloud(n,n.byteLength,c);else throw Error(`THREE.DRACOLoader: Unexpected geometry type.`);if(!l.ok()||c.ptr===0)throw Error(`THREE.DRACOLoader: Decoding failed: `+l.error_msg());let d={index:null,attributes:[]};for(let n in o){let r=self[s[n]],l,u;if(a.useUniqueIDs)u=o[n],l=t.GetAttributeByUniqueId(c,u);else{if(u=t.GetAttributeId(c,e[o[n]]),u===-1)continue;l=t.GetAttribute(c,u)}let f=i(e,t,c,n,r,l);n===`color`&&(f.vertexColorSpace=a.vertexColorSpace),d.attributes.push(f)}return u===e.TRIANGULAR_MESH&&(d.index=r(e,t,c)),e.destroy(c),d}function r(e,t,n){let r=n.num_faces()*3,i=r*4,a=e._malloc(i);t.GetTrianglesUInt32Array(n,i,a);let o=new Uint32Array(e.HEAPF32.buffer,a,r).slice();return e._free(a),{array:o,itemSize:1}}function i(e,t,n,r,i,o){let s=n.num_points(),c=o.num_components(),l=a(e,i),u=c*i.BYTES_PER_ELEMENT,d=Math.ceil(u/4)*4,f=d/i.BYTES_PER_ELEMENT,p=s*u,m=s*d,h=e._malloc(p);t.GetAttributeDataArrayForAllPoints(n,o,l,p,h);let g=new i(e.HEAPF32.buffer,h,p/i.BYTES_PER_ELEMENT),_;if(u===d)_=g.slice();else{_=new i(m/i.BYTES_PER_ELEMENT);let e=0;for(let t=0,n=g.length;t<n;t++){for(let n=0;n<c;n++)_[e+n]=g[t*c+n];e+=f}}return e._free(h),{name:r,count:s,itemSize:c,array:_,stride:f}}function a(e,t){switch(t){case Float32Array:return e.DT_FLOAT32;case Int8Array:return e.DT_INT8;case Int16Array:return e.DT_INT16;case Int32Array:return e.DT_INT32;case Uint8Array:return e.DT_UINT8;case Uint16Array:return e.DT_UINT16;case Uint32Array:return e.DT_UINT32}}}var _d={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Od.BlurDirectionX=new V(1,0),Od.BlurDirectionY=new V(0,1);var Z=new In;Z.background=new K(8894680),Z.fog=new Fn(13164008,80,280);var kd=new vo(60,window.innerWidth/window.innerHeight,.1,300),Ad=new du({antialias:!0,powerPreference:`high-performance`,failIfMajorPerformanceCaveat:!1});Ad.setSize(window.innerWidth,window.innerHeight),Ad.setPixelRatio(window.devicePixelRatio),Ad.shadowMap.enabled=!0,Ad.shadowMap.type=2,Ad.toneMapping=4,Ad.toneMappingExposure=1.1,(document.getElementById(`root`)??document.body).appendChild(Ad.domElement);var jd=new(window.AudioContext||window.webkitAudioContext),Md,Nd,Pd;function Fd(){if(Pd)return;Pd=jd.createGain(),Pd.connect(jd.destination),Pd.gain.value=.3,Md=jd.createOscillator(),Md.type=`sawtooth`;let e=jd.createGain(),t=jd.createBiquadFilter();t.type=`lowpass`,t.frequency.value=400,Md.connect(t),t.connect(e),e.connect(Pd),e.gain.value=.1,Md.start();let n=2*jd.sampleRate,r=jd.createBuffer(1,n,jd.sampleRate),i=r.getChannelData(0);for(let e=0;e<n;e++)i[e]=Math.random()*2-1;Nd=jd.createBufferSource(),Nd.buffer=r,Nd.loop=!0;let a=jd.createBiquadFilter();a.type=`lowpass`,a.frequency.value=500;let o=jd.createGain();Nd.connect(a),a.connect(o),o.connect(Pd),o.gain.value=.05,Nd.start(),window.audioData={engineFilter:t,engineGain:e,engineOsc:Md,windFilter:a,windGain:o}}function Id(e,t,n){if(!Pd)return;let r=jd.createOscillator(),i=jd.createGain();r.type=t,r.frequency.setValueAtTime(e,jd.currentTime),r.frequency.exponentialRampToValueAtTime(10,jd.currentTime+n),i.gain.setValueAtTime(.2,jd.currentTime),i.gain.exponentialRampToValueAtTime(.01,jd.currentTime+n),r.connect(i),i.connect(Pd),r.start(),r.stop(jd.currentTime+n)}Ad.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),console.warn(`WebGL context lost — close other WebGL tabs and refresh.`);let t=document.createElement(`div`);t.style.cssText=`position:fixed;inset:0;background:#000;color:#fff;display:flex;align-items:center;justify-content:center;z-index:9999;font-family:monospace;font-size:1.2rem;text-align:center;padding:2rem;`,t.innerHTML=`<div><b style="color:#ff4444">WEBGL CONTEXT LOST</b><br><br>Close other browser tabs then<br><br><button onclick="location.reload()" style="padding:1rem 2rem;background:#fff;color:#000;border:none;cursor:pointer;font-weight:900;font-size:1rem;">RELOAD GAME</button></div>`,document.body.appendChild(t)},!1),Ad.domElement.addEventListener(`webglcontextrestored`,()=>{console.log(`WebGL context restored.`),Ad.setAnimationLoop(lm)},!1);var Ld=new Ed(Z,kd),Rd=new Od(new V(window.innerWidth,window.innerHeight),.15,.05,.92),zd=new Td(Ad);zd.addPass(Ld),zd.addPass(Rd);function Bd(){let e=document.createElement(`canvas`);e.width=512,e.height=512;let n=e.getContext(`2d`);n.fillStyle=`#2a2a2d`,n.fillRect(0,0,512,512);for(let e=0;e<4e4;e++){let e=Math.random()*512,t=Math.random()*512,r=Math.random()*15;n.fillStyle=`rgb(${35+r},${35+r},${38+r})`,n.fillRect(e,t,1,1)}n.fillStyle=`rgba(0,0,0,0.15)`,n.fillRect(512*.1,0,512*.25,512),n.fillRect(512*.65,0,512*.25,512);let r=new ia(e);return r.wrapS=r.wrapT=t,r.repeat.set(4,1e3),r}var Vd=new Sa({map:Bd(),color:16777215,roughness:.9,metalness:.05}),Hd=new Sa({color:7043674,roughness:1});function Ud(){let e=new ca(1,1,1);[new Sa({color:13157564,roughness:.8}),new Sa({color:10137796,roughness:.2,metalness:.5}),new Sa({color:14538960,roughness:.9})].forEach((t,n)=>{let r=new Di(e,t,17);r.frustumCulled=!0;let i=new En;for(let e=0;e<17;e++){let t=12+Math.random()*22,a=20+Math.random()*60,o=12+Math.random()*22,s=(e+n)%2==0?1:-1;i.position.set(s*(55+Math.random()*80),a/2,-100-n*60-e*35),i.scale.set(t,a,o),i.updateMatrix(),r.setMatrixAt(e,i.matrix)}r.instanceMatrix.needsUpdate=!0,Z.add(r)})}Ud();var Wd=new Eo(15266040,.8);Z.add(Wd);var Gd=new ao(14215416,4013357,.6);Z.add(Gd);var Kd=new To(16774630,1.8);Kd.position.set(100,150,80),Kd.castShadow=!0,Kd.shadow.mapSize.width=1024,Kd.shadow.mapSize.height=1024,Kd.shadow.camera.left=-50,Kd.shadow.camera.right=50,Kd.shadow.camera.top=50,Kd.shadow.camera.bottom=-50,Z.add(Kd);var qd=new To(11192552,.4);qd.position.set(-40,20,-30),Z.add(qd);var Jd=new q(new ua(400,1200),Hd);Jd.name=`ground`,Jd.rotation.x=-Math.PI/2,Jd.position.set(0,-.05,-100),Z.add(Jd);var Yd=6e3,Xd=16,Zd=new q(new ua(Xd,Yd),Vd);Zd.name=`road`,Zd.rotation.x=-Math.PI/2,Zd.position.set(0,.01,-Yd/2+50),Zd.receiveShadow=!0,Z.add(Zd);var Qd=new Sa({color:1710620,roughness:1}),$d=new ua(1.5,Yd);[-1,1].forEach(e=>{let t=new q($d,Qd);t.rotation.x=-Math.PI/2,t.position.set(e*(Xd/2+.75),.005,-Yd/2+50),Z.add(t)});var ef=new Sa({color:10262672,roughness:.85}),tf=new ca(.5,1.1,4),nf=750,rf=new Di(tf,ef,nf*2),af=new En;for(let e=0;e<nf;e++)for(let t=-1;t<=1;t+=2)af.position.set(t*(Xd/2+.3),.55,-e*4),af.updateMatrix(),rf.setMatrixAt(e*2+ +(t===1),af.matrix);rf.instanceMatrix.needsUpdate=!0,Z.add(rf);var of=new Dn;Z.add(of);var sf=new Wr({color:16777215}),cf=new Wr({color:16766720}),lf=new q(new ua(.2,Yd),cf);lf.rotation.x=-Math.PI/2,lf.position.set(-Xd/2+.4,.06,-Yd/2+50),of.add(lf);var uf=new q(new ua(.2,Yd),sf);uf.rotation.x=-Math.PI/2,uf.position.set(Xd/2-.4,.06,-Yd/2+50),of.add(uf),[-4,0,4].forEach((e,t)=>{for(let n=0;n<150;n++){let r=new q(new ua(.15,6),sf);if(r.rotation.x=-Math.PI/2,r.position.set(e,.05,50-n*20),of.add(r),n%2==0){let r=new q(new ca(.12,.08,.12),new Wr({color:t===0?16766720:16777215}));r.position.set(e,.08,50-n*20+3.5),of.add(r)}}});var df=new la(.1,.15,8,8),ff=new Sa({color:4473924,metalness:.8,roughness:.2}),pf=new ca(2,.1,.1),mf=new ca(.6,.2,.4),hf=new Sa({color:2236962}),gf=new Wr({color:16777198}),_f=new ua(.5,.3),vf=new Di(df,ff,150),yf=new Di(pf,ff,150),bf=new Di(mf,hf,150),xf=new En;for(let e=0;e<75;e++){let t=e%2==0?-1:1,n=-e*40;xf.position.set(t*(Xd/2+2.5),4,n),xf.updateMatrix(),vf.setMatrixAt(e,xf.matrix),xf.position.set(t*(Xd/2+1.6),8,n),xf.rotation.z=0,xf.updateMatrix(),yf.setMatrixAt(e,xf.matrix),xf.position.set(t*(Xd/2+.7),7.9,n),xf.updateMatrix(),bf.setMatrixAt(e,xf.matrix);let r=new q(_f,gf);r.rotation.x=Math.PI/2,r.position.set(t*(Xd/2+.7),7.75,n),Z.add(r)}vf.instanceMatrix.needsUpdate=!0,yf.instanceMatrix.needsUpdate=!0,bf.instanceMatrix.needsUpdate=!0,Z.add(vf,yf,bf);var Sf=new ca(.4,12,.4),Cf=new ua(8,3),wf=new Sa({color:19750,roughness:.5});for(let e=0;e<10;e++){let t=-450-e*600,n=new q(Sf,ff);n.position.set(-Xd/2-2,6,t),Z.add(n);let r=n.clone();r.position.x=Xd/2+2,Z.add(r);let i=new q(new ca(Xd+4,.3,.3),ff);i.position.set(0,11,t),Z.add(i);let a=new q(Cf,wf);a.position.set(0,9,t+.2),Z.add(a)}var Tf={basic:[{q:`Solve: 15 + 27`,a:[`32`,`42`,`45`,`52`],c:1},{q:`Which word is a synonym for 'Happy'?`,a:[`Gloomy`,`Cheerful`,`Bored`,`Angry`],c:1},{q:`What is 10% of 500?`,a:[`5`,`50`,`100`,`500`],c:1},{q:`Identify the noun: 'The blue car drove fast.'`,a:[`Blue`,`Fast`,`Car`,`Drove`],c:2},{q:`Complete: 2, 4, 8, 16, ...`,a:[`24`,`32`,`20`,`64`],c:1},{q:`What is 3 squared plus 4 squared?`,a:[`7`,`12`,`25`,`49`],c:2},{q:`Which of these is an even number?`,a:[`13`,`27`,`42`,`55`],c:2},{q:`Antonym of 'Hot'?`,a:[`Warm`,`Cold`,`Burning`,`Spicy`],c:1},{q:`How many sides does a hexagon have?`,a:[`5`,`6`,`7`,`8`],c:1},{q:`Identify the verb: 'She jumped over the fence.'`,a:[`Fence`,`Jumped`,`Over`,`She`],c:1},{q:`Simplify: 40 / 5 + 2`,a:[`8`,`10`,`6`,`12`],c:1}],advanced:[{q:`If x + 7 = 15, what is the value of x^2?`,a:[`64`,`49`,`81`,`121`],c:0},{q:`Which word is a synonym for 'Abundant'?`,a:[`Scarce`,`Plentiful`,`Sparse`,`Rare`],c:1},{q:`What is the area of a circle with radius 3? (Approx)`,a:[`18.8`,`28.3`,`9.4`,`12.6`],c:1},{q:`Complete the analogy: Book is to Read as Fork is to...`,a:[`Drink`,`Cut`,`Eat`,`Wash`],c:2},{q:`Which of these is a prime number?`,a:[`15`,`21`,`29`,`33`],c:2},{q:`What is the square root of 225?`,a:[`13`,`14`,`15`,`16`],c:2},{q:`Solve for y: 3y - 9 = 21`,a:[`8`,`10`,`12`,`6`],c:1},{q:`Who wrote 'Hamlet'?`,a:[`Dickens`,`Twain`,`Shakespeare`,`Homer`],c:2},{q:`What is the chemical symbol for Gold?`,a:[`Ag`,`Fe`,`Au`,`Pb`],c:2},{q:`Convert 2/5 to a percentage.`,a:[`20%`,`40%`,`50%`,`25%`],c:1},{q:`What is the slope of the line y = 3x - 5?`,a:[`-5`,`3`,`-3`,`5`],c:1},{q:`Which word means 'to move away from'?`,a:[`Accede`,`Recede`,`Proceed`,`Concede`],c:1},{q:`If a triangle has angles 40 and 60, what is the third angle?`,a:[`80`,`90`,`100`,`70`],c:0},{q:`What is the main gas in Earth's atmosphere?`,a:[`Oxygen`,`Nitrogen`,`Carbon`,`Argon`],c:1},{q:`Solve: 2^4 - 2^3`,a:[`8`,`16`,`4`,`12`],c:0},{q:`Identify the figure of speech: 'The wind whispered.'`,a:[`Simile`,`Metaphor`,`Personification`,`Hyperbole`],c:2}]},Ef=[7103487,16737668,4450481,16760331,3835647,54527,16711765,7103487,16760331,4450481],Df=[];for(let e=1;e<=20;e++)Df.push(-e*280);var Of=[];Df.forEach((e,t)=>{let n=new q(new ca(.8,4.5,.8),new Sa({color:1118481,metalness:.9,roughness:.1}));n.name=`checkpointPillarLeft_${t}`,n.position.set(-Xd/2-1.2,2.25,e),Z.add(n);let r=n.clone();r.name=`checkpointPillarRight_${t}`,r.position.set(Xd/2+1.2,2.25,e),Z.add(r);let i=new q(new ca(Xd+3.5,.6,1.2),new Sa({color:1118481,metalness:1,roughness:.05}));i.name=`checkpointArch_${t}`,i.position.set(0,4.5,e),Z.add(i);let a=new q(new ua(Xd-.8,4.5),new Wr({color:Ef[t%Ef.length],transparent:!0,opacity:.15,side:2}));a.position.set(0,2.25,e),Z.add(a),Of.push({arch:i,z:e,color:Ef[t%Ef.length],curtain:a})});var kf=document.getElementById(`loading-status`),Af=document.getElementById(`start-btn`),jf=document.getElementById(`start-overlay`),Mf=document.getElementById(`crash-overlay`),Nf=new Ja;Nf.onProgress=(e,t,n)=>{let r=Math.round(t/n*100);kf&&(kf.textContent=`LOADING ASSETS: ${r}%`)},Nf.onLoad=()=>{kf&&(kf.textContent=`SYSTEMS ONLINE`),Af&&(Af.style.display=`block`)};var Q=new Dn;Q.name=`car`,Q.position.set(0,0,10),Z.add(Q);var Pf=[];for(let e=0;e<20;e++){let e=new q(new ua(.1,5),new Wr({color:16777215,transparent:!0,opacity:.2}));e.rotation.x=-Math.PI/2,e.position.set((Math.random()-.5)*Xd,.08,Q.position.z-Math.random()*200),Z.add(e),Pf.push(e)}var Ff=new hu(Nf),If=new hd;If.setDecoderPath(`https://www.gstatic.com/draco/versioned/decoders/1.5.7/`),Ff.setDRACOLoader(If);var Lf=null;Ff.load(`./assets/models/ferrari.glb`,e=>{Lf=e.scene,Lf.rotation.y=0,Lf.scale.set(1,1,1);let t=new q(new ca(.4,.15,.1),new Sa({color:16777215,emissive:16777215,emissiveIntensity:1}));t.position.set(.8,.5,-2.2),Lf.add(t);let n=t.clone();n.position.x=-.8,Lf.add(n);let r=new bo(16774630,12,60,Math.PI/4,.3,1);r.position.set(0,.5,-2.2),r.target.position.set(0,0,-20),Lf.add(r),Lf.add(r.target);let i=new q(new ca(.5,.2,.1),new Sa({color:16711680,emissive:16711680,emissiveIntensity:1}));i.position.set(.8,.5,2.2),Lf.add(i);let a=i.clone();a.position.x=-.8,Lf.add(a);let o=new q(new la(.1,0,1.5,8),new Sa({color:16755200,emissive:16755200,emissiveIntensity:.5,transparent:!0,opacity:.8}));o.position.set(.6,.4,2.5),o.rotation.x=-Math.PI/2,o.name=`exhaust_left`,Lf.add(o);let s=o.clone();s.position.x=-.6,s.name=`exhaust_right`,Lf.add(s),Lf.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0,e.name.includes(`body`)&&(e.material=new Sa({color:11141120,metalness:1,roughness:.02,envMapIntensity:2.5})))}),Q.add(Lf),Lf.name=`playerMesh`,Q.userData.exhL=o,Q.userData.exhR=s,Q.userData.body=Lf.getObjectByName(`carBody`)||Lf,console.log(`Main Car Loaded`)});var Rf=[];function zf(e){Q.children.forEach(e=>{e.name===`playerMesh`&&Q.remove(e)});let t,n=[11141120,9080207,657930,662587,3816768],r=[`premium`,`sedan`,`suv`,`premium`,`hatchback`];if(e===1&&Lf)t=Lf.clone();else{let i=r[(e-1)%r.length];t=Jp(i),t.traverse(t=>{t.isMesh&&t.material&&(t.material=new Sa({color:n[(e-1)%n.length],metalness:1,roughness:.05,envMap:Z.environment,envMapIntensity:2}))})}t.name=`playerMesh`,Q.add(t);let i=t.getObjectByName(`exhaust_left`)||t.userData.wheels?.[0],a=t.getObjectByName(`exhaust_right`)||t.userData.wheels?.[1];Q.userData.exhL=i,Q.userData.exhR=a}Rf.forEach(e=>{e.traverse(e=>{e.isMesh&&e.material&&(e.material.envMap=Z.environment,e.material.envMapIntensity=1.5)})});var Bf=!1,Vf=0;Af.onclick=()=>{Fd(),jd.state===`suspended`&&jd.resume(),jf.style.display=`none`,Bf=!0,Cp=Date.now()};function Hf(e=!1){Bf=!1,Dp=!1,Kf=0,tp=0,Q.position.set(0,0,10),Q.rotation.set(0,0,0),Tp=1,zf(_p),wp=yp[_p-1],$p.set(0,6,14),Op&&=(Z.remove(Op),null),kp&&=(Z.remove(kp),null),document.querySelectorAll(`div`).forEach(e=>{(e.textContent===`CONGRATULATIONS`||e.textContent===`MISSION COMPLETE`)&&e.remove()}),e||(Sp=0,Vf=0,_p=1),bp=0,xp=0,Ep=3,rm.clear();let t=1+(_p-1)*.12,n=Math.min(6+(_p-1),12);Vp.forEach(e=>Z.remove(e.mesh)),Vp.length=0;for(let e=0;e<n;e++)Xp(-100-e*40);Vp.forEach(e=>{e.speed*=t}),gm(),_m(),lp.textContent=e?Sp.toLocaleString():`0`,dp&&(dp.textContent=_p),fp&&(fp.textContent=bp),pp&&(pp.textContent=vp[_p-1]),mp&&(mp.style.width=`0%`);let r=document.getElementById(`game-over-overlay`);r&&r.remove();let i=document.getElementById(`win-overlay`);i&&i.remove(),Mf.style.display=`none`,setTimeout(()=>{Bf=!0,Cp=Date.now()},100)}function Uf(){let e=new Dn,t=new Sa({color:10263708,metalness:.8,roughness:.3}),n=new q(new la(.07,.1,9,6),t);n.position.y=4.5,e.add(n);let r=new q(new ca(2.5,.1,.1),t);r.position.set(1.25,8.8,0),e.add(r);let i=new Sa({color:15263968,roughness:.3}),a=new q(new ca(.7,.2,.4),i);return a.position.set(2.5,8.75,0),e.add(a),e}for(let e=0;e<75;e++){let t=e%2==0?-1:1,n=Uf();n.position.set(t*(Xd/2+4.5),0,-e*40-10),t===1&&(n.rotation.y=Math.PI),Z.add(n)}function Wf(){let e=new Dn,t=new Sa({color:8947840,roughness:.7}),n=new q(new ca(.3,10,.3),t);n.position.y=5,e.add(n);let r=new q(new ca(8,4,.3),t);r.position.y=10.5,e.add(r);let i=new Sa({color:16117995,roughness:.8}),a=new q(new ua(7.8,3.8),i);return a.position.set(0,10.5,.16),e.add(a),e}[-90,-180,-270,-360,-450,-540].forEach((e,t)=>{let n=t%2==0?-1:1,r=Wf();r.position.set(n*28,0,e),r.rotation.y=n===1?-.3:.3,Z.add(r)});var Gf=new Sa({color:7048282,roughness:1});for(let e=0;e<12;e++){let t=35+Math.random()*25,n=new q(new da(t,12,8),Gf),r=e%2==0?1:-1;n.position.set(r*(120+Math.random()*80),-t+5,-200-e*120),Z.add(n)}new vs(Ad).compileEquirectangularShader(),new no().setPath(`./assets/skybox/`).load([`px.jpg`,`nx.jpg`,`py.jpg`,`ny.jpg`,`pz.jpg`,`nz.jpg`],e=>{Z.environment=e,Z.background=e,Z.backgroundBlurriness=.5});var $={w:!1,a:!1,s:!1,d:!1,space:!1},Kf=0,qf=.72,Jf=1.15,Yf=.008,Xf=.018,Zf=.004,Qf=.02,$f=.004,ep=.85,tp=0,np=.1,rp=-Xd/2+1.2,ip=Xd/2-1.2,ap=0,op=120;Bf=!0;var sp=document.getElementById(`speedo-value`),cp=document.getElementById(`stat-gear`),lp=document.getElementById(`stat-score`),up=document.getElementById(`stat-time`),dp=document.getElementById(`stat-level`),fp=document.getElementById(`stat-unit-current`),pp=document.getElementById(`stat-unit-total`),mp=document.getElementById(`progress-bar`),hp=document.getElementById(`pedal-accel`),gp=document.getElementById(`pedal-brake`),_p=1,vp=[10,20,30,40,50],yp=[120,300,600,900,1200],bp=0,xp=0,Sp=0,Cp=Date.now(),wp=0,Tp=1,Ep=3,Dp=!1,Op=null,kp=null;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();(t===`w`||t===`arrowup`)&&($.w=!0,hp.classList.add(`active`)),(t===`s`||t===`arrowdown`)&&($.s=!0,gp.classList.add(`active`)),(t===`a`||t===`arrowleft`)&&($.a=!0),(t===`d`||t===`arrowright`)&&($.d=!0),(t===` `||t===`space`)&&($.space=!0)}),window.addEventListener(`keyup`,e=>{let t=e.key.toLowerCase();(t===`w`||t===`arrowup`)&&($.w=!1,hp.classList.remove(`active`)),(t===`s`||t===`arrowdown`)&&($.s=!1,gp.classList.remove(`active`)),(t===`a`||t===`arrowleft`)&&($.a=!1),(t===`d`||t===`arrowright`)&&($.d=!1),(t===` `||t===`space`)&&($.space=!1)}),hp.addEventListener(`touchstart`,e=>{e.preventDefault(),$.w=!0,hp.classList.add(`active`)}),hp.addEventListener(`touchend`,()=>{$.w=!1,hp.classList.remove(`active`)}),gp.addEventListener(`touchstart`,e=>{e.preventDefault(),$.s=!0,gp.classList.add(`active`)}),gp.addEventListener(`touchend`,()=>{$.s=!1,gp.classList.remove(`active`)});var Ap=document.getElementById(`steering-zone`),jp=document.getElementById(`joystick-knob`),Mp=document.getElementById(`steering-wheel-icon`),Np=!1,Pp=0,Fp=10,Ip=55;function Lp(e){return Math.max(-Ip,Math.min(Ip,e-Pp))}function Rp(e){jp.style.transform=`translate(calc(-50% + ${e}px), -50%)`;let t=e/Ip*90;Mp.style.transform=`rotate(${t}deg)`,Math.abs(e)<Fp?($.a=!1,$.d=!1):e<0?($.a=!0,$.d=!1):($.d=!0,$.a=!1)}function zp(){Np=!1,jp.style.transform=`translate(-50%, -50%)`,Mp.style.transform=`rotate(0deg)`,$.a=!1,$.d=!1}Ap.addEventListener(`touchstart`,e=>{e.preventDefault(),Np=!0,Pp=e.touches[0].clientX,Rp(0)},{passive:!1}),Ap.addEventListener(`touchmove`,e=>{e.preventDefault(),Np&&Rp(Lp(e.touches[0].clientX))},{passive:!1}),Ap.addEventListener(`touchend`,zp),Ap.addEventListener(`touchcancel`,zp),Ap.addEventListener(`mousedown`,e=>{Np=!0,Pp=e.clientX,Rp(0)}),window.addEventListener(`mousemove`,e=>{Np&&Rp(Lp(e.clientX))}),window.addEventListener(`mouseup`,()=>{Np&&zp()});var Bp=document.getElementById(`nitro-btn`);Bp.addEventListener(`touchstart`,e=>{e.preventDefault(),$.space=!0,Bp.classList.add(`active`)}),Bp.addEventListener(`touchend`,()=>{$.space=!1,Bp.classList.remove(`active`)}),Bp.addEventListener(`mousedown`,()=>{$.space=!0,Bp.classList.add(`active`)}),Bp.addEventListener(`mouseup`,()=>{$.space=!1,Bp.classList.remove(`active`)}),hp.addEventListener(`mousedown`,()=>{$.w=!0,hp.classList.add(`active`)}),gp.addEventListener(`mousedown`,()=>{$.s=!0,gp.classList.add(`active`)}),window.addEventListener(`mouseup`,()=>{$.w=!1,$.s=!1,hp.classList.remove(`active`),gp.classList.remove(`active`)});var Vp=[],Hp=new Sa({color:328965,roughness:.1,metalness:1}),Up=new Wr({color:1118481}),Wp=new Wr({color:16777215}),Gp=new Wr({color:11141120}),Kp=new la(.35,.35,.28,8),qp=Object.values({black:657930,silver:9080207,white:16448250,grey:3816768,blue:662587,red:4852234});function Jp(e=`sedan`){let t=new Dn,n=2,r=.8,i=4,a=.6,o=2,s=-.2;e===`premium`?(n=2.1,r=.7,i=4.6,a=.5,o=2.2,s=-.1):e===`suv`?(n=2.2,r=1.1,i=4.8,a=.7,o=2.6,s=.2):e===`hatchback`&&(n=1.9,r=.9,i=3.6,a=.6,o=2,s=.4);let c=qp[Math.floor(Math.random()*qp.length)],l=new Sa({color:c,metalness:.9,roughness:.2,envMapIntensity:1}),u=new q(new ca(n,r,i),l);u.position.set(0,r/2+.3,0),t.add(u);let d=new q(new ca(n*.85,a,o),Hp);d.position.set(0,r+.3+a/2-.05,s),t.add(d);let f=[];[{x:n/2,y:.35,z:i/2-.7},{x:-n/2,y:.35,z:i/2-.7},{x:n/2,y:.35,z:-i/2+.7},{x:-n/2,y:.35,z:-i/2+.7}].forEach(e=>{let n=new Dn,r=new q(Kp,Up);r.rotation.z=Math.PI/2,n.add(r),n.position.set(e.x,e.y,e.z),t.add(n),f.push(n)});let p=new q(new ua(.4,.1),Wp);p.position.set(n/2-.35,r*.8+.3,-i/2-.01),t.add(p);let m=p.clone();m.position.x*=-1,t.add(m);let h=new q(new ua(.5,.12),Gp);h.position.set(n/2-.4,r*.8+.3,i/2+.01),t.add(h);let g=h.clone();return g.position.x*=-1,t.add(g),t.userData={type:e,width:n,length:i,wheels:f},t}var Yp=8;function Xp(e){let t=[-5.25,-1.75,1.75,5.25],n=t[Math.floor(Math.random()*t.length)],r,i=`sedan`;if(Rf.length>0&&Math.random()>.5){let e=Rf[Math.floor(Math.random()*Rf.length)];r=e.clone(),i=e.userData.type||`sedan`,r.rotation.y=Math.PI}else{let e=[`sedan`,`suv`,`hatchback`,`premium`];i=e[Math.floor(Math.random()*e.length)],r=Jp(i)}r.position.set(n,0,e),Z.add(r);let a=.12+Math.random()*.1;i===`suv`&&(a*=.7),i===`premium`&&(a*=1.2),Vp.push({mesh:r,speed:a,isStatic:!1,type:i})}for(let e=0;e<Yp;e++)Xp(-40-e*40);var Zp=new Dn,Qp=new q(new la(8,8,80,8,1,!0,0,Math.PI),new Wr({color:1710618,side:1}));Qp.rotation.z=Math.PI/2,Qp.rotation.y=Math.PI/2,Zp.add(Qp),Zp.position.set(0,0,-150),Z.add(Zp);var $p=new H(0,6,14),em=new H(0,2,-10),tm=new H,nm=new H,rm=new Set,im=0,am=new H,om=new H,sm={score:-1,time:``,progress:-1},cm=document.createElement(`div`);cm.className=`checkpoint-notify`,cm.style.display=`none`,document.body.appendChild(cm);function lm(){if(!Bf)return;im+=.016;let e=$.space&&Kf>.1,t=e?Jf:qf,n=e?Xf:Yf;Dp&&(t=.35),Kf=$.w?Math.min(Kf+n,t):$.s?Math.max(Kf-Qf,0):Math.max(Kf-Zf,0),kp&&!Dp&&(Kf=Math.max(Kf*.985,.1));let r=0;$.a?(tp=Math.max(tp-$f,-np),ap=At.lerp(ap,-op,.12)):$.d?(tp=Math.min(tp+$f,np),ap=At.lerp(ap,op,.12)):(tp*=ep,ap=At.lerp(ap,0,.08)),Q.position.x+=tp*(Kf*1.2+.6)*6,Q.position.x=At.clamp(Q.position.x,rp,ip),r=-tp*.45,Q.rotation.z=At.lerp(Q.rotation.z,r,.1),Q.rotation.y=At.lerp(Q.rotation.y,-tp*.25,.1),Q.position.z-=Kf*2,Q.position.z<-6e3&&(Q.position.z=10,rm.clear());let i=e?72:60;if(Math.abs(kd.fov-i)>.1&&(kd.fov=At.lerp(kd.fov,i,.08),kd.updateProjectionMatrix()),sp.textContent=Math.round(Kf*240).toString().padStart(1,`0`),cp.textContent=Kf>.01?Kf>.6?`5`:`3`:`N`,window.audioData){let{engineOsc:t,engineFilter:n,engineGain:r,windFilter:i,windGain:a}=window.audioData,o=40+Kf*120+(e?40:0);t.frequency.setTargetAtTime(o,jd.currentTime,.1),n.frequency.setTargetAtTime(400+Kf*800,jd.currentTime,.1),r.gain.setTargetAtTime($.w?.15:.08,jd.currentTime,.2),i.frequency.setTargetAtTime(100+Kf*1500,jd.currentTime,.1),a.gain.setTargetAtTime(Kf*.15,jd.currentTime,.1)}let a=(Date.now()-Cp)/1e3,o=Math.max(0,yp[_p-1]-a);if(o<=0&&Bf){Bf=!1,vm(`MISSION FAILED // TIME EXPIRED`);return}let s=`${Math.floor(o/60).toString().padStart(2,`0`)}:${Math.floor(o%60).toString().padStart(2,`0`)}`;sm.time!==s&&(up.textContent=s,up.style.color=o<30?`#ff0033`:`#fff`,o<10?up.style.animation=`pulse 0.5s infinite`:up.style.animation=`none`,sm.time=s);let c=Math.min(Math.abs(Q.position.z)/Yd*100,100),l=Math.floor(c);if(sm.progress!==l&&(mp.style.width=`${c}%`,sm.progress=l),sm.score!==Sp&&(lp.textContent=Sp.toLocaleString(),sm.score=Sp),dp&&(dp.textContent=_p),c>=100){mm();return}let u=Q.userData.exhL,d=Q.userData.exhR;if(u&&d){let e=$.space&&Kf>.1,t=$.w?(1+Math.sin(im*30)*.3)*(e?2:1):.2;u.scale.set(t,t,t),d.scale.set(t,t,t);let n=e?8965375:16755200;u.userData.lastColor!==n&&(u.material.color.setHex(n),d.material.color.setHex(n),u.material.emissive.setHex(n),d.material.emissive.setHex(n),u.userData.lastColor=n),u.material.emissiveIntensity=$.w?(e?4:2)+Math.sin(im*50)*.5:.5,d.material.emissiveIntensity=u.material.emissiveIntensity}Vp.forEach(e=>{if(e.mesh.position.z-=e.speed,e.mesh.userData.wheels&&e.speed>0){let t=e.speed*2;for(let n=0;n<e.mesh.userData.wheels.length;n++)e.mesh.userData.wheels[n].children[0].rotation.x+=t}if(e.mesh.position.z>Q.position.z+25){e.mesh.position.z=Q.position.z-300;let t=Of.find(e=>!rm.has(Of.indexOf(e)));t&&Math.abs(e.mesh.position.z-t.z)<40&&(e.mesh.position.z-=60);let n=[-5.25,-1.75,1.75,5.25];e.mesh.position.x=n[Math.floor(Math.random()*n.length)]}let t=Math.abs(Q.position.x-e.mesh.position.x),n=Math.abs(Q.position.z-e.mesh.position.z),r=e.mesh.userData.width||2,i=e.mesh.userData.length||4;t<(2+r)/2-.2&&n<(4.4+i)/2-.2&&(Bf=!1,Id(100,`square`,.5),Ep--,gm(),Ep<=0?vm():(Mf.style.display=`flex`,setTimeout(()=>{Q.position.x=0,Kf=0,Bf=!0,Mf.style.display=`none`},2e3)))}),Of.forEach((e,t)=>{!rm.has(t)&&Math.abs(Q.position.z-e.z)<5&&fm(t),e.curtain&&(e.curtain.material.opacity=.05+Math.sin(im*8+t)*.05)}),Pf.forEach(e=>{e.position.z+=Kf*5,e.position.z>Q.position.z+20&&(e.position.z=Q.position.z-200,e.position.x=(Math.random()-.5)*(Xd-2)),e.scale.y=Kf*5+.1,e.material.opacity=Kf*.3}),Kf>.1&&(Sp+=Math.floor(Kf*5));let f=0,p=0;if(Bf&&(Kf>1.2&&(f=(Math.random()-.5)*(Kf*.05),p=(Math.random()-.5)*(Kf*.05)),Mf.style.display===`flex`&&(f=(Math.random()-.5)*.6,p=(Math.random()-.5)*.6)),am.set(Q.position.x*.5+f,Q.position.y+$p.y+p,Q.position.z+$p.z),om.set(Q.position.x*.7,Q.position.y+em.y,Q.position.z+em.z),tm.lerp(am,.08),nm.lerp(om,.12),kd.position.copy(tm),kd.lookAt(nm),Kf>.1&&(Sp+=Math.floor(Kf*5)),Dp&&Op&&Math.abs(Q.position.z-Op.position.z)<12&&dm(),kp&&kp.userData.states){let e=kp.userData.states,t=new G,n=new jt,r=new H(1,1,1);e.forEach((e,i)=>{e.pos.y-=e.speed,e.rot.x+=e.spin,e.rot.y+=e.spin,e.pos.x+=Math.sin(im+e.wobble)*.04,e.pos.z+=Math.cos(im+e.wobble)*.02,e.pos.y<0&&(e.pos.y=25),n.setFromEuler(e.rot),t.compose(e.pos,n,r),kp.setMatrixAt(i,t)}),kp.instanceMatrix.needsUpdate=!0}zd.render()}function um(e){Op&&Z.remove(Op);let t=new Dn,n=new ca(2,12,2),r=new ca(Xd+4,1.5,2),i=new Sa({color:1118481,roughness:.2,metalness:.8}),a=new q(n,i);a.position.set(-Xd/2-1,6,0),t.add(a);let o=new q(n,i);o.position.set(Xd/2+1,6,0),t.add(o);let s=new q(r,i);s.position.set(0,11,0),t.add(s);let c=new ca(Xd+4,.5,.5),l=new Sa({color:3355443,metalness:.8});for(let e=0;e<3;e++){let n=new q(c,l);n.position.set(0,10+e*1,.3),t.add(n)}let u=new q(new ua(Xd-2,1.2),new Wr({color:4450481,transparent:!0,opacity:.95}));u.position.set(0,11,1.05),t.add(u);let d=new la(.2,.2,1.5),f=new Sa({color:0}),p=new Wr({color:16777215});for(let e=0;e<5;e++){let n=new q(d,f);n.position.set(-Xd/2-.5,.75,-10-e*8),t.add(n);let r=new q(d,f);r.position.set(Xd/2+.5,.75,-10-e*8),t.add(r);let i=new q(new da(.1),p);i.position.set(0,.8,0),n.add(i.clone()),r.add(i.clone())}let m=new ua(Xd,.4),h=new Wr({color:16777215,transparent:!0,opacity:.8});for(let e=0;e<3;e++){let n=new q(m,h);n.rotation.x=-Math.PI/2,n.position.set(0,.06,-5+e*1.5),t.add(n)}let g=new q(new ua(Xd,60),new Wr({color:4450481,transparent:!0,opacity:.08,side:2}));g.rotation.x=-Math.PI/2,g.position.set(0,.05,-10),t.add(g),t.position.set(0,0,e),Z.add(t),Op=t,Dp=!0,Vp.forEach(t=>{t.mesh.position.z<Q.position.z&&t.mesh.position.z>e-50&&(Z.remove(t.mesh),t.mesh.position.y=-100)})}function dm(){if(!Dp)return;Dp=!1,Id(660,`sine`,.3),setTimeout(()=>Id(880,`sine`,.3),150),setTimeout(()=>Id(1100,`sine`,.3),300);let e=new Di(new ua(.12,.2),new Wr({color:15794164,side:2,transparent:!0,opacity:.6,blending:2}),200),t=new G,n=new H,r=new ln,i=new jt,a=new H(1,1,1),o=[];for(let s=0;s<200;s++)n.set((Math.random()-.5)*40,15+Math.random()*20,Q.position.z-30+(Math.random()-.5)*40),r.set(Math.random()*Math.PI,Math.random()*Math.PI,0),i.setFromEuler(r),t.compose(n,i,a),e.setMatrixAt(s,t),o.push({pos:n.clone(),rot:r.clone(),speed:.05+Math.random()*.1,spin:(Math.random()-.5)*.1,wobble:Math.random()*Math.PI});e.instanceMatrix.needsUpdate=!0,Z.add(e),kp=e,kp.userData.states=o;let s=document.createElement(`div`);s.style.cssText=`position:fixed; top:40%; left:50%; transform:translate(-50%, -50%); color:#fff; font-weight:900; font-size:4rem; letter-spacing:10px; text-transform:uppercase; z-index:3000; animation: pulse 1.2s infinite; text-shadow: 0 0 30px #43E8B1; pointer-events:none; opacity: 0; transition: opacity 0.8s;`,s.textContent=`CONGRATULATIONS`,document.body.appendChild(s),requestAnimationFrame(()=>{s.style.opacity=`1`}),$p.z;let c=setInterval(()=>{$p.z=Math.min($p.z+.1,22),$p.y=Math.min($p.y+.05,9)},16);setTimeout(()=>{s.style.opacity=`0`,s.style.transition=`opacity 1.5s`,clearInterval(c);let e=setInterval(()=>{$p.z=Math.max($p.z-.2,14),$p.y=Math.max($p.y-.1,6),$p.z===14&&$p.y===6&&clearInterval(e)},16);setTimeout(()=>{s.remove(),kp&&=(Z.remove(kp),null),Op&&=(Z.remove(Op),null),hm()},1500)},2e3)}tm.copy(Q.position).add($p),nm.copy(Q.position).add(em),Ad.setAnimationLoop(lm);function fm(e){rm.add(e),Tp=Math.max(Tp,e+2),Id(880,`sine`,.2);let t=Math.min(.2+(_p-1)*.15,.7),n=Math.random()<t?Tf.advanced:Tf.basic,r=n[Math.floor(Math.random()*n.length)];pm(e,r)}function pm(e,t){Bf=!1;let n=document.createElement(`div`);n.id=`question-modal`,n.className=`overlay-active`,n.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.85);display:flex;align-items:center;justify-content:center;z-index:2000;`;let r=``;t.a.forEach((e,t)=>{r+=`<button class="answer-btn" data-idx="${t}" style="width:100%; padding:1.5rem; margin:0.5rem 0; background:#111; color:#fff; border:2px solid #333; font-size:1.2rem; cursor:pointer; font-weight:900; text-align:left;">${e}</button>`}),n.innerHTML=`
        <div class="brutalist-panel" style="width: 90%; max-width: 600px; padding: 2.5rem; border-color: #${Ef[e%Ef.length].toString(16).padStart(6,`0`)};">
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.5rem; border-bottom:2px solid rgba(255,255,255,0.1); padding-bottom:0.5rem;">
                ...
                <span style="font-size:0.8rem; font-weight:900; color:rgba(255,255,255,0.5);">CHECKPOINT ${e+1}</span>
            </div>
            <h2 style="color:#fff; font-size:1.6rem; margin-bottom:2rem; font-family:'Inter', sans-serif; line-height:1.4;">${t.q}</h2>
    ...
    `,document.body.appendChild(n),n.querySelectorAll(`.answer-btn`).forEach(e=>{e.onclick=()=>{if(parseInt(e.getAttribute(`data-idx`))===t.c){if(e.style.background=`#43E8B1`,e.style.color=`#000`,Sp+=2500,Vf++,bp++,Id(1200,`sine`,.3),fp&&(fp.textContent=bp),mp){let e=vp[_p-1];mp.style.width=`${Math.min(100,bp/e*100)}%`}if(cm.textContent=`CORRECT // MISSION RESUMED`,cm.style.color=`#43E8B1`,Kf=.4,bp>=vp[_p-1]){setTimeout(()=>{n.remove(),um(Q.position.z-150),cm.textContent=`FINAL UNIT VALIDATED // PROCEED TO ARRIVAL ZONE`,cm.style.color=`#43E8B1`,cm.style.display=`block`,Bf=!0,setTimeout(()=>cm.style.display=`none`,3e3)},1e3);return}}else e.style.background=`#ff0033`,Sp-=500,Ep--,xp++,gm(),Id(150,`sawtooth`,.4),cm.textContent=`INCORRECT // REDUCED SPEED MODE`,cm.style.color=`#ff0033`,Kf=.1;cm.style.display=`block`,setTimeout(()=>{n.remove(),Ep<=0?vm():Bf=!0,setTimeout(()=>cm.style.display=`none`,2e3)},1e3)}})}function mm(){Bf=!1;let e=document.createElement(`div`);e.id=`win-overlay`,e.className=`overlay-active`,e.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.8);display:flex;align-items:center;justify-content:center;z-index:1000;`,e.innerHTML=`
        <div class="brutalist-panel" style="padding: 3rem; text-align: center; border-color: #43E8B1; max-width: 500px;">
            ...
            <div style="margin: 2rem 0; text-align: left; background: rgba(255,255,255,0.05); padding: 1.5rem; border: 1px solid rgba(255,255,255,0.1);">
                ...
                <div style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                    ...
                    <span style="color: #fff; font-family: monospace;">${Sp.toLocaleString()}</span>
                </div>
                <div style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                ...
                <div style="display: flex; justify-content: space-between;">
                    ...
                    <span style="color: #43E8B1; font-family: monospace;">${Math.round(Vf/(Vf+xp)*100)}%</span>
                </div>
            </div>
    ...
    `,document.body.appendChild(e)}function hm(){Bf=!1;let e=document.createElement(`div`);e.id=`level-complete-overlay`,e.className=`overlay-active`,e.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.92);display:flex;align-items:center;justify-content:center;z-index:2500;`,e.innerHTML=`
        <div class="brutalist-panel" style="padding: 3rem; text-align: center; border-color: #43E8B1; max-width: 550px;">
            <p style="color: #43E8B1; font-weight: 900; letter-spacing: 4px; margin: 0; font-size: 0.8rem; text-transform: uppercase;">Mission Debrief // Level ${_p}</p>
            ...
            <div style="margin-bottom: 2.5rem; text-align: left; background: rgba(255,255,255,0.05); padding: 2rem; border: 1px solid rgba(255,255,255,0.1);">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                    <div>
                        ...
                        <span style="color: #43E8B1; font-family: monospace; font-weight: 900; font-size: 1.4rem;">${bp}</span>
                    </div>
                    <div>
                        ...
                        <span style="color: #ff0033; font-family: monospace; font-weight: 900; font-size: 1.4rem;">${xp}</span>
                    </div>
                </div>
                ...
                <div style="margin-top: 1.5rem; padding-top: 1rem; border-top: 1px solid rgba(255,255,255,0.1);">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                        ...
                        <span style="color: #6C63FF; font-family: monospace; font-weight: 900;">+${(_p*1e3).toLocaleString()}</span>
                    </div>
                    ${xp===0?`
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 1rem; border-top: 1px solid rgba(255,255,255,0.2); padding-top: 1rem;">
                        ...
                        <span style="color: #fff; font-family: monospace; font-weight: 900; font-size: 1.5rem;">${(Sp+_p*1e3+(xp===0?5e3:0)).toLocaleString()}</span>
                    </div>
                </div>
            </div>
            ...
            <div style="display: flex; gap: 1rem;">
                ...
                <button id="next-level-btn" style="flex: 2; padding: 1.2rem; background: #6C63FF; color: #fff; border: none; cursor: pointer; font-weight: 900; letter-spacing: 2px; font-size: 1.1rem;">PROCEED TO LEVEL ${_p+1}</button>
            </div>
        </div>
    `,document.body.appendChild(e),document.getElementById(`replay-level-btn`).onclick=()=>{e.remove(),Hf(!0)},document.getElementById(`next-level-btn`).onclick=()=>{Sp+=_p*1e3,xp===0&&(Sp+=5e3),e.remove(),_p>=5?mm():(_p++,Hf(!0))}}function gm(){document.querySelectorAll(`.lives-container .heart`).forEach((e,t)=>{t>=Ep?e.classList.add(`lost`):e.classList.remove(`lost`)})}function _m(){document.querySelectorAll(`#mastery-badges .heart`).forEach((e,t)=>{t<_p-1?(e.style.opacity=`1`,e.style.background=`#43E8B1`,e.style.boxShadow=`0 0 10px #43E8B1`):(e.style.opacity=`0.2`,e.style.background=`#fff`,e.style.boxShadow=`none`)})}function vm(){Bf=!1;let e=document.createElement(`div`);e.id=`game-over-overlay`,e.className=`overlay-active`,e.innerHTML=`
        <div class="brutalist-panel" style="padding: 3rem; text-align: center;">
            ...
            <p style="color: #fff; margin: 1rem 0;">FINAL SCORE: ${Sp}</p>
    ...
    `,document.body.appendChild(e),document.getElementById(`retry-btn`).onclick=()=>{Hf()}}window.addEventListener(`resize`,()=>{kd.aspect=window.innerWidth/window.innerHeight,kd.updateProjectionMatrix(),Ad.setSize(window.innerWidth,window.innerHeight),zd.setSize(window.innerWidth,window.innerHeight)}),Ad.setAnimationLoop(lm);
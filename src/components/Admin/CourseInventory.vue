<template>
  <div v-for="course in courses" :key="course._id" 
       class="bg-[var(--neo-surface)] border border-slate-200 dark:border-zinc-800 rounded-[32px] overflow-hidden hover:shadow-neo-md transition-all duration-500 group mb-8">
    <div class="p-8 flex items-center gap-7">
      <div class="w-16 h-16 rounded-[24px] bg-slate-50 dark:bg-zinc-800/50 flex items-center justify-center group-hover:bg-zinc-900 dark:group-hover:bg-white shadow-neo-inner transition-all duration-500">

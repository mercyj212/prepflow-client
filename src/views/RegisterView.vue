      ...
      <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 bg-white dark:bg-zinc-950 transition-colors duration-300">
        <div class="w-full max-w-sm relative">
          ...
          <div class="mb-8 text-center lg:text-left">
            ...
            <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-2 font-sans">Join thousands of students and start your journey today.</p>
          </div>
          ...
          <div class="mt-8 pt-8 border-t border-zinc-100 dark:border-zinc-800">
            <div class="relative group">
              <div class="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 transition-all font-bold text-sm">Sign up with Google</div>
          ...
          <div class="mt-8 text-center text-xs sm:text-sm font-medium">
            ...
            <router-link to="/login" class="text-indigo-500 dark:text-indigo-400 font-bold hover:underline transition-all">Identity Login -></router-link>
          </div>
        </div>
      </div>
    </div>

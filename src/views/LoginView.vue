<template>
  <div class="min-h-[100svh] bg-[#fafafa] dark:bg-zinc-950 flex flex-col transition-colors duration-300">
    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-start lg:justify-center items-center px-6 py-6 lg:p-16 bg-white dark:bg-zinc-950 transition-colors duration-300 min-h-full lg:min-h-screen">
      <div class="w-full max-w-sm relative">
        ...
        <div class="mb-6">
          ...
          <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">Instant 1-click login or sign in below.</p>
        </div>

        <!-- ⚡ 1-CLICK GOOGLE LOGIN (PRIMARY TOP CHOICE) -->
        <div class="mb-6">
